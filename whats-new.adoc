...
.AFX 2K 儲存系統
全新的 NetApp AFX 2K 儲存系統擴展了其解耦式解決方案，旨在滿足高效能 NAS 和 S3 工作負載（包括 AI/ML 應用）的嚴苛要求。AFX 2K 系統為需要可擴充、高吞吐量檔案和物件儲存的客戶提供專業功能。

link:https://docs.netapp.com/us-en/ontap-afx/get-started/ontap-afx-storage.html["了解有關 AFX 系統的更多信息"] 。

.Cisco 9808 交換器新增對 AFX 2K 的支援
新型 Cisco 9808 交換器透過儲存機架連接至 AFX 2K 控制器節點。這款新型交換器與 Cisco 9364D-GX2A 和 Cisco 9332D-GX2B 交換器搭配使用，可建置包含兩個以上節點的 ONTAP 叢集。採用進階通訊協定以最佳化效能。此設計以 VLAN 標記搭配多網路路徑為基礎，並支援技術更新配置，以確保持續運作及輕鬆升級。
