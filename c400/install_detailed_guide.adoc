...
NOTE: 如果看不到卡上的連接埠標籤、您可以檢查卡安裝方向（C400的PCIe連接器插槽位於卡插槽左側）、然後在NetApp Hardware Universe ® 其中顯示了帶有連接埠標籤的擋板圖形。您可以使用sysconfig -A命令或系統壓縮清單來找到卡片零件編號。
...
+
image::../media/drw_c400_TNSC-network-cabling.png[DRW C400 TSC網路纜線]
...
+
image::../media/drw_c400_switched_network_cabling.png[DRW C400交換式網路纜線]
...
+
image::../media/drw_c400_one_ns224_shelves.png[DRW C400單一n224磁碟櫃]
...
+
image::../media/drw_c400_two_ns224_shelves.png[DRW C400兩個新南224磁碟櫃]
