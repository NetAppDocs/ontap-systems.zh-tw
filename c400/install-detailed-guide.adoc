...
[role="lead"]
使用詳細指南安裝和設定您的 AFF C400 儲存系統，該指南提供從機架安裝和佈線到初始系統啟動的逐步說明。
...
. 將纜線管理裝置連接至控制器背面（如圖所示）。
+
image::../media/drw_c400_cable_tray_IEOPS-1208.svg[DRW C400 纜線匣 IEOPS 1208]
...
. 使用下圖完成控制器與交換器之間的纜線：
+
image::../media/drw_c400_TNSC-networking-cabling_IEOPS-1189.svg[DRW C400 TNSC 網路纜線 IEOPS 1189]
...
. 使用下圖完成控制器與交換器之間的纜線：
+
image::../media/drw_c400_switched_network_cabling_IEOPS-1190.svg[DRW C400 交換式網路纜線 IEOPS 1190]
...
. 使用下圖將控制器連接至單一磁碟機櫃。
+
image::../media/drw_c400_one_ns224_shelf_IEOPS-1191.svg[DRW C400 ONE ns224 機櫃 IEOPS 1191]
...
. 使用下列圖例將控制器連接至兩個磁碟機櫃。
+
image::../media/drw_c400_two_ns224_shelves_IEOPS-1192.svg[DRW C400 兩個 ns224 機櫃 IEOPS 1192]
