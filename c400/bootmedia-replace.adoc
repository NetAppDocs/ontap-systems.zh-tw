...
summary: 若要更換開機媒體、您必須移除受損的控制器模組、安裝替換的開機媒體、並將開機映像傳輸到USB快閃磁碟機。 
---
= 使用手冊開機恢復程序更換 AFF C400 儲存系統中的開機媒體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更換 AFF C400 儲存系統中的開機媒體，方法是移除受損的控制器模組、安裝替換開機媒體，然後使用 USB 快閃磁碟機傳輸開機映像。
