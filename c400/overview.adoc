...
[role="lead"]
以下是AFF C400的部分規格。訪問 https://hwu.netapp.com["NetApp Hardware Universe"^]（HWU）取得AFF C400規格的完整清單。此頁面反映的是單一高可用性對。
...
| 網路儲存 | 12 | 35.4 PB / 31.4 PiB | 3072GB 


| 儲存區域網絡 | 6 | 17.7 PB / 15.7 PiB | 1536GB 


| HA 對 |  | 2.9 PB / 2.6 PiB | 256.0000 
|===
...
* 聲學噪音：標稱聲功率 (LwAd)：8.5；聲壓 (LpAm)（旁觀者位置）：67.2 分貝
