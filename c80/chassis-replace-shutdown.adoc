...
summary: 當您需要更換機箱時，請關閉 AFF C80 儲存系統中的控制器。在執行維護或元件更換之前，請務必安全關閉控制器，以避免資料遺失並確保系統穩定性。 
---
= 關閉控制器 - AFF C80
:allow-uri-read: 
:icons: font
...
[role="lead"]
當您需要更換機箱時，請關閉 AFF C80 儲存系統中的控制器。在執行維護或元件更換之前，請務必安全關閉控制器，以避免資料遺失並確保系統穩定性。
