...
summary: 在 AFF C80 儲存系統中，您可以將故障的 IO 模組更換為相同類型的 IO 模組，也可以更換為不同類型的 IO 模組。此外，您也可以為系統中的空插槽新增 IO 模組。 
---
= 了解如何在 AFF C80 儲存系統中新增和更換 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
熱插拔 I/O 模組可讓您在不關閉系統的情況下更換故障模組，從而最大限度地減少停機時間並保持系統可用性。
