...
summary: 當您的 AFF C80 系統中的交流電或直流電源供應器故障或發生故障時，請更換電源供應器，以確保系統持續獲得穩定運作所需的電力。更換過程包括：斷開故障電源供應器與電源的連接、拔除電源線、更換故障電源供應器，然後重新連接至電源。 
---
= 在 AFF C80 儲存系統中熱插拔電源供應單元
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當 AFF C80 系統故障或故障時，請更換其中的 AC 或 DC 電源供應器（ PSU ），以確保您的系統能繼續接收所需的電力，以便穩定運作。更換程序包括中斷故障 PSU 與電源的連接，拔下電源線，更換故障 PSU ，然後將其重新連接至電源。
