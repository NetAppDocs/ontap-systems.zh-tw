...
summary: 在更換AFF C80 系統中的機殼之前，請確保滿足成功更換的必要要求。這包括驗證系統中的所有其他元件是否正常運作，驗證您是否擁有ONTAP 的本機管理員憑證、正確的替換機箱以及必要的工具。 
---
= 在更換 AFF C80 系統機箱之前，請先檢閱相關要求。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更換AFF C80 系統中的機殼之前，請確保滿足成功更換的必要要求。這包括驗證系統中的所有其他元件是否正常運作，驗證您是否擁有ONTAP 的本機管理員憑證、正確的替換機箱以及必要的工具。
