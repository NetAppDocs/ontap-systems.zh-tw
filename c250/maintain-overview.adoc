...
summary: 維護 AFF C250 硬體 
---
= 了解如何維護您的 AFF C250 儲存系統
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
維護您的 AFF C250 儲存系統的硬體，以確保長期可靠性和最佳效能。定期執行維護任務，例如更換故障元件，這有助於防止停機和資料遺失。

維護程序假設 AFF C250 儲存系統已作為儲存節點部署在 ONTAP 環境中。
...
對於 AFF C250 儲存系統、您可以對下列元件執行維護程序。
