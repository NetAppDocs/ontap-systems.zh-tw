...
* link:https://docs.netapp.com/us-en/ontap-systems-switches/cluster/index.html["集群交換機"^]
* link:https://docs.netapp.com/us-en/ontap-systems-switches/storage/index.html["儲存交換機"^]
...
[role="quick-margin-list"]
* link:aff-aseries/index.html["AFF A 系列系統"]
* link:aff-cseries/index.html["AFF C 系列系統"]
