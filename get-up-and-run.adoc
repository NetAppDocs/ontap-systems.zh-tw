...
sidebar: sidebar 
keywords:  
summary: 若要使用 AFF 、 ASA 和 FAS 系統開始運作、您必須在 ONTAP 中安裝硬體元件、設定交換器和設定儲存設備。 
---
...
[role="lead"]
若要使用 AFF 、 ASA 和 FAS 系統開始運作、您必須在 ONTAP 中安裝硬體元件、設定交換器和設定儲存設備。
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["一"] 安裝控制器
[role="quick-margin-para"]
在機架或機櫃中安裝 AFF 、 ASA 和 FAS 控制器。存取您平台機型的安裝與設定指示。
...
* https://docs.netapp.com/us-en/ontap-systems/a200/install-setup.html["解答200 AFF"]
...
[role="quick-margin-para"]
設定交換器並安裝必要軟體之後、請存取平台機型的安裝與設定指示、以完成系統設定。
