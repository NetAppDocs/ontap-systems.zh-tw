...
summary: 您可以根據儲存系統硬體配置的不同，使用不同的程式來關閉或接管故障控制器。FAS2700 系統僅支援手動啟動媒體復原程序。 
---
= 在開機媒體恢復期間，關閉 FAS2700 系統中受損的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用適合您配置的相應程式關閉或接管故障控制器。FAS2700 系統僅支援手動啟動媒體復原程序。不支援自動啟動媒體恢復。
