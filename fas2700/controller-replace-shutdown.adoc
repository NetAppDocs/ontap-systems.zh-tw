...
summary: 在更換 FAS2700 系統中受損控制器之前，請先將其關閉，方法是接管該控制器並將其停止至 LOADER 提示字元。 
---
= 在更換之前，請先關閉 FAS2700 系統中發生故障的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更換 FAS2700 系統中受損控制器之前，請先將其關閉，方法是接管該控制器並將其停止至 LOADER 提示字元。
