...
summary: 當儲存系統遇到過多的可修正 ECC 錯誤或不可修正 ECC 錯誤時，請更換 FAS2700 系統中的 DIMM，這通常是由單一 DIMM 故障所引起的。 
---
= 更換 FAS2700 系統中的 DIMM 以修復記憶體容量錯誤
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當儲存系統遇到過多的可修正 ECC 錯誤或不可修正 ECC 錯誤時，請更換 FAS2700 系統中的 DIMM，這通常是由單一 DIMM 故障所引起的。
