...
summary: 當 FAS50 系統故障或故障時，請更換 FAS50 系統中的 AC 或 DC 電源供應器（ PSU ），以確保您的系統能持續獲得所需的電力，以便穩定運作。更換程序包括中斷故障 PSU 與電源的連接，拔下電源線，更換故障 PSU ，然後將其重新連接至電源。 
---
= 更換電源供應器- FAS50
:allow-uri-read: 
:icons: font
...
[role="lead"]
當 FAS50 系統故障或故障時，請更換 FAS50 系統中的 AC 或 DC 電源供應器（ PSU ），以確保您的系統能持續獲得所需的電力，以便穩定運作。更換程序包括中斷故障 PSU 與電源的連接，拔下電源線，更換故障 PSU ，然後將其重新連接至電源。
