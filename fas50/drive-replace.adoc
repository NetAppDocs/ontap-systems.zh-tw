...
summary: 當 FAS50 儲存系統中的磁碟機發生故障或需要升級時，可對其進行熱插拔。更換過程包括識別故障磁碟機、安全地將其移除，然後安裝新磁碟機，以確保持續的資料存取和系統效能。 
---
= 在 FAS50 系統中熱插拔磁碟機
:allow-uri-read: 
:icons: font
...
[role="lead"]
當 FAS50 儲存系統中的磁碟機發生故障或需要升級時，可對其進行熱插拔。更換過程包括識別故障磁碟機、安全地將其移除，然後安裝新磁碟機，以確保持續的資料存取和系統效能。
