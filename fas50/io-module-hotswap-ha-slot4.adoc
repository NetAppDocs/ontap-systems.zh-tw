...
summary: 叢集和 HA I/O 模組支援叢集互連和高可用性。當模組發生故障時，您可以在 FAS50 儲存系統中熱插拔該模組。 
---
= 熱插拔用於叢集和 HA 流量的 I/O 模組 - FAS50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
叢集和 HA I/O 模組支援叢集和高可用性互連。當模組發生故障且您的儲存系統符合特定要求時，您可以在 FAS50 儲存系統中熱插拔該模組。
