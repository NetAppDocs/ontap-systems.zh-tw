...
image::../media/drw_isi_fas50_4p_25gbe_optional_cabling_ieops-1934.svg[纜線 fas50 至 10/25 GbE 乙太網路主機網路交換器]
...
+
其他支援的 SAS 機架的佈線方式類似。請參閱 link:../sas3/install-new-system.html["安裝並連接新系統安裝所需的機櫃"^]。您也可以參考 link:../sas3/overview-cabling-rules-examples.html["SAS 佈線規則、工作表和範例總覽"^]。
