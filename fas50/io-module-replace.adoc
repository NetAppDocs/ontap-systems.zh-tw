...
summary: 當 FAS50 儲存系統中的 I/O 模組發生故障或需要升級以支援更高的效能或附加功能時，請更換此模組。更換過程包括關閉控制器、更換故障的 I/O 模組、重新啟動控制器，以及將故障零件退回NetApp。 
---
= 更換 FAS50 系統中的 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當 FAS50 儲存系統中的 I/O 模組發生故障或需要升級以支援更高的效能或附加功能時，請更換此模組。更換過程包括關閉控制器、更換故障的 I/O 模組、重新啟動控制器，以及將故障零件退回NetApp。
