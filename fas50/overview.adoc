...
[role="lead"]
以下是單一高可用性對中 FAS50 儲存系統的精選規格。請造訪NetApp Hardware Universe (HWU) 以了解此儲存系統的完整規格。
...
* 類型：NAS；HA 對：4；原始容量：42.2 PB / 37.5 PiB；最大記憶體：512 GB
* 類型：SAN；HA 對：4；原始容量：42.2 PB / 37.5 PiB；最大記憶體：512 GB
* 類型：HA 對；原始容量：10.6 PB / 9.4 PiB；最大記憶體：128.0000
