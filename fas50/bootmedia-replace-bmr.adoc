...
summary: FAS50 儲存系統中的啟動媒體儲存了重要的韌體和設定資料。更換過程包括移除控制器模組、移除損壞的啟動介質、安裝替換啟動介質，然後重新安裝控制器模組。 
---
= 使用自動開機恢復流程更換 FAS50 系統中的開機媒體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS50 儲存系統中的啟動媒體儲存了重要的韌體和設定資料。更換過程包括移除控制器模組、移除損壞的啟動介質、安裝替換啟動介質，然後重新安裝控制器模組。
