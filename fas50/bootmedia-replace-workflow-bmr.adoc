...
summary: 啟動映像的自動恢復涉及系統自動識別並選擇適當的啟動選單選項。它會使用合作夥伴節點上的啟動映像在 FAS50 儲存系統中的替換啟動媒體上重新安裝ONTAP 。 
---
= 啟動媒體自動復原工作流程 - FAS50
:allow-uri-read: 
:icons: font
...
[role="lead"]
啟動映像的自動恢復涉及系統自動識別並選擇適當的啟動選單選項。它會使用合作夥伴節點上的啟動映像在 FAS50 儲存系統中的替換啟動媒體上重新安裝ONTAP 。
