...
summary: 維護 AFF A400 儲存系統的硬體，以確保其長期可靠性和最佳效能。定期維護工作，例如更換故障組件，有助於防止停機和資料遺失。 
---
= 了解如何維護您的 AFF A400 儲存系統
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
維護 AFF A400 儲存系統的硬體，以確保其長期可靠性和最佳效能。定期維護工作，例如更換故障組件，有助於防止停機和資料遺失。

維護過程假定AFF A400儲存系統已部署為ONTAP環境中的儲存節點。
...
對於 AFF A400 儲存系統、您可以對下列元件執行維護程序。
