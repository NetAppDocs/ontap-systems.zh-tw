...
summary: 開機媒體儲存系統開機時所使用的主要和次要系統檔案集。 
---
= 查看更換 AFF A400 系統中開機媒體的要求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更換 AFF A400 系統中的開機媒體之前，請確認您符合成功更換的必要條件。這包括擁有一個格式化為 FAT32 且具有足夠儲存空間以存放 ONTAP 恢復映像的 USB 隨身碟，並確定您的更換作業是不中斷營運的還是中斷式的。
