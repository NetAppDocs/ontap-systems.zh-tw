...
[role="lead"]
使用最適合您需求的格式（快速步驟、影片步驟或詳細步驟）安裝並設定 AFF C800 儲存系統。

* link:../c800/install-quick-guide.html["快速步驟"]
+
可列印的PDF逐步說明、並提供其他內容的即時連結。

* link:../c800/install-videos.html["影片步驟"]
+
視訊逐步指示。

* link:../c800/install-detailed-guide.html["詳細步驟"]
+
線上逐步指示、並提供其他內容的即時連結。
