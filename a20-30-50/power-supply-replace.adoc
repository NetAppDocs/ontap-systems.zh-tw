...
summary: 當 A20 ， A30 或 A50 系統故障或故障時，請更換 AFF A20 ， AFF A30 或 AFF A50 系統中的 AC 或 DC 電源供應器（ PSU ），以確保您的系統能繼續接收所需的電力，以便穩定運作。更換程序包括中斷故障 PSU 與電源的連接，拔下電源線，更換故障 PSU ，然後將其重新連接至電源。 
---
...
[role="lead"]
當 A20 ， A30 或 A50 系統故障或故障時，請更換 AFF A20 ， AFF A30 或 AFF A50 系統中的 AC 或 DC 電源供應器（ PSU ），以確保您的系統能繼續接收所需的電力，以便穩定運作。更換程序包括中斷故障 PSU 與電源的連接，拔下電源線，更換故障 PSU ，然後將其重新連接至電源。
