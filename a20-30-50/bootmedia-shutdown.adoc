...
summary: 關閉 AFF A20 ， AFF A30 或 AFF A50 儲存系統中受損的控制器，以防止資料遺失，並確保更換開機媒體時系統穩定。 
---
= 關閉控制器以更換開機媒體： AFF A20 ， AFF A30 和 AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉 AFF A20 ， AFF A30 或 AFF A50 儲存系統中受損的控制器，以防止資料遺失，並確保更換開機媒體時系統穩定。
