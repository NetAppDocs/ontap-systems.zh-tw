...
summary: 關閉AFF A20、 AFF A30 或AFF A50 儲存系統中受損的控制器，以防止資料遺失並在自動啟動媒體復原過程中保持系統穩定性。 
---
= 在自動開機恢復過程中，關閉 AFF A20、AFF A30 或 AFF A50 系統中的控制器。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉AFF A20、 AFF A30 或AFF A50 儲存系統中受損的控制器，以防止資料遺失並在自動啟動媒體復原過程中保持系統穩定性。
