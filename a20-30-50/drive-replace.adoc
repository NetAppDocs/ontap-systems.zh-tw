...
summary: 當磁碟機故障或需要升級時，請更換 AFF A20 ， AFF A30 或 AFF A50 系統中的磁碟機。更換程序包括識別故障的磁碟機，安全地移除磁碟機，以及安裝新磁碟機，以確保資料存取和系統效能不中斷。 
---
= 更換磁碟機 - AFF A20 ， AFF A30 和 AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當磁碟機故障或需要升級時，請更換 AFF A20 ， AFF A30 或 AFF A50 系統中的磁碟機。更換程序包括識別故障的磁碟機，安全地移除磁碟機，以及安裝新磁碟機，以確保資料存取和系統效能不中斷。
