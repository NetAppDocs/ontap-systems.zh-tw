...
summary: 當AFF A20、 AFF A30 或AFF A50 儲存系統中的 I/O 模組發生故障或需要升級以支援更高效能或其他功能時，請更換此模組。更換過程包括關閉控制器、更換故障的 I/O 模組、重新啟動控制器，以及將故障零件退回NetApp。 
---
= 更換 AFF A20、AFF A30 或 AFF A50 系統中的 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當您的 AFF A20、AFF A30 或 AFF A50 儲存系統中的 I/O 模組發生故障或需要升級以支援更高的效能或其他功能時，請更換該 I/O 模組。

更換過程包括關閉控制器、更換故障的 I/O 模組、重新啟動控制器，並將故障零件退回 NetApp。
