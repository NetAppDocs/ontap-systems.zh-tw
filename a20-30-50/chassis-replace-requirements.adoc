...
summary: 在更換 AFF A20、AFF A30 或 AFF A50 儲存系統的機箱之前，請確認您符合成功更換所需的所有條件。這包括確認系統中的所有其他組件均運作正常、確認您擁有正確的替換機箱，以及確認您擁有必要的工具。 
---
= 更換 AFF A20、AFF A30 或 AFF A50 機箱前，請先查看相關要求。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更換 AFF A20、AFF A30 或 AFF A50 儲存系統的機箱之前，請確認您符合成功更換所需的所有條件。這包括確認系統中的所有其他組件均運作正常、確認您擁有正確的替換機箱，以及確認您擁有必要的工具。
