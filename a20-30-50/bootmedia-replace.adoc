...
summary: AFF A20、 AFF A30 或AFF A50 儲存系統中的啟動媒體儲存了必要的韌體和設定資料。更換過程包括移除控制器模組、移除損壞的啟動介質、安裝替換啟動介質，然後使用 USB 隨身碟將ONTAP映像手動傳輸到替換啟動介質。 
---
= 使用手動開機恢復流程更換 AFF A20、AFF A30 或 AFF A50 系統中的開機媒體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A20、 AFF A30 或AFF A50 儲存系統中的啟動媒體儲存了必要的韌體和設定資料。更換過程包括移除控制器模組、移除損壞的啟動介質、安裝替換啟動介質，然後使用 USB 隨身碟將ONTAP映像手動傳輸到替換啟動介質。
