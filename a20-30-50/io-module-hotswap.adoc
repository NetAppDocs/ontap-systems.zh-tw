...
summary: 如果 AFF A20、AFF A30 或 AFF A50 儲存系統中的某個乙太網路 I/O 模組發生故障，且您的儲存系統符合所有 ONTAP 版本要求，則可以熱插拔該模組。 
---
= 在 AFF A20、AFF A30 或 AFF A50 系統中熱交換 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果 AFF A20、AFF A30 或 AFF A50 儲存系統中的某個乙太網路 I/O 模組發生故障，且您的儲存系統符合所有 ONTAP 版本要求，則可以熱插拔該模組。

要熱交換 I/O 模組，請驗證您的儲存系統是否符合 ONTAP 版本要求，準備好您的儲存系統和 I/O 模組，熱交換故障模組，將替換模組上線，將儲存系統還原至正常運作，並將故障模組退回 NetApp。
