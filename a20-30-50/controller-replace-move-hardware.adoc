...
summary: 當硬體故障需要時，請更換 AFF A20 ， AFF A30 或 AFF A50 系統中的控制器。更換程序包括移除受損的控制器，將元件移至更換控制器，安裝更換控制器，然後重新啟動。 
---
= 更換控制器 - AFF A20 ， AFF A30 和 AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當硬體故障需要時，請更換 AFF A20 ， AFF A30 或 AFF A50 系統中的控制器。更換程序包括移除受損的控制器，將元件移至更換控制器，安裝更換控制器，然後重新啟動。
...
.接下來呢？
更換了功能受損的 AFF A20 ， AFF A30 或 AFF A50 控制器之後，您需要link:controller-replace-system-config-restore-and-verify.html["還原系統組態"]。
