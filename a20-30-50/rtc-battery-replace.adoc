...
summary: 更換 AFF A20 ， AFF A30 或 AFF A50 系統中的即時時鐘（ RTC ）電池（通常稱為幣式電池），以確保仰賴精確時間同步的服務和應用程式仍能正常運作。 
---
...
[role="lead"]
更換 AFF A20 ， AFF A30 或 AFF A50 系統中的即時時鐘（ RTC ）電池（通常稱為幣式電池），以確保仰賴精確時間同步的服務和應用程式仍能正常運作。
