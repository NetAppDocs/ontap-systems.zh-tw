...
summary: 當風扇發生故障或無法有效運作時，請更換AFF A20、 AFF A30 或AFF A50 儲存系統中的風扇模組，因為這會影響系統冷卻和整體效能。更換過程包括關閉控制器、移除控制器、更換風扇、重新安裝控制器以及將故障部件退回給NetApp。 
---
= 在 AFF A20、AFF A30 或 AFF A50 系統中熱插拔風扇模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當風扇發生故障或無法有效運作時，請更換AFF A20、 AFF A30 或AFF A50 儲存系統中的風扇模組，因為這會影響系統冷卻和整體效能。更換過程包括關閉控制器、移除控制器、更換風扇、重新安裝控制器以及將故障部件退回給NetApp。
