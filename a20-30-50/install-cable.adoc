...
summary: 安裝 AFF A20 ， AFF A30 或 AFF A50 儲存系統硬體後，請將控制器連接至網路和機櫃。 
---
= 為您的 AFF A20、AFF A30 或 AFF A50 硬體連接網路和儲存設備
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:../media/drw_isi_a20_switched_2p_25gbe_cabling_ieops-2019.svg["使用一個 25 GbE I/O 模組的 a20 交換式叢集佈線圖"]
...
.AFF A20、AFF A30 或 AFF A50，配備一個 4 埠 10/25 GbE I/O 模組
...
.AFF A20、AFF A30 或 AFF A50，配備一個 4 埠 64 Gb/s FC I/O 模組
