...
summary: AFF A20、AFF A30 和 AFF A50 平台的主要規格 
---
= AFF A20、AFF A30 和 AFF A50 平台的主要規格
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
以下是 AFF A20、AFF A30 和 AFF A50 平台組的部分規格。請造訪 https://hwu.netapp.com["NetApp Hardware Universe"^]（HWU）查看完整規格清單。這些規格反映單一高可用度配對。
