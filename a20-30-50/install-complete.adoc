...
summary: 開啟 AFF A20 ， AFF A30 或 AFF A50 儲存系統之後，您就可以開始探索叢集網路並設定 ONTAP 叢集。 
---
= 完整的儲存系統設定與組態： AFF A20 ， AFF A30 和 AFF A50
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
開啟 AFF A20 ， AFF A30 或 AFF A50 儲存系統之後，您就可以開始探索叢集網路並設定 ONTAP 叢集。
