...
summary: 首先，請檢閱更換需求，關閉控制器，移除和更換機箱，以及驗證系統作業，以更換 AFF A20 ， AFF A30 或 AFF A50 儲存系統中的機箱。 
---
...
[role="lead"]
首先，請檢閱更換需求，關閉控制器，移除和更換機箱，以及驗證系統作業，以更換 AFF A20 ， AFF A30 或 AFF A50 儲存系統中的機箱。
