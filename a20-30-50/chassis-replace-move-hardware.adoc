...
summary: 當硬體故障需要更換AFF A20、 AFF A30 或AFF A50 儲存系統的機箱。更換過程包括移除控制器、移除驅動器、安裝更換機箱以及重新安裝機箱組件。 
---
= 更換 AFF A20、AFF A30 或 AFF A50 系統中的機箱
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當硬體故障需要更換AFF A20、 AFF A30 或AFF A50 儲存系統的機箱。更換過程包括移除控制器、移除驅動器、安裝更換機箱以及重新安裝機箱組件。
