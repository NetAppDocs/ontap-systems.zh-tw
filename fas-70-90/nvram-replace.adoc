...
summary: 當非揮發性記憶體故障或需要升級時，請更換 FAS70 或 FAS90 系統中的 NVRAM 。 
---
= 更換 FAS70 或 FAS90 系統中的 NVRAM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當非揮發性記憶體故障或需要升級時，請更換 FAS70 或 FAS90 系統中的 NVRAM 。更換程序包括關閉受損的控制器，更換 NVRAM 模組或 NVRAM DIMM ，重新分配磁碟，以及將故障零件退回 NetApp 。
