...
summary: 啟動映像的自動恢復涉及系統自動識別並選擇適當的啟動選單選項。它使用合作夥伴節點上的啟動映像在 FAS70 或 FAS90 儲存系統中的替換啟動媒體上重新安裝ONTAP 。 
---
= 啟動介質自動復原工作流程 - FAS70 和 FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
啟動映像的自動恢復涉及系統自動識別並選擇適當的啟動選單選項。它使用合作夥伴節點上的啟動映像在 FAS70 或 FAS90 儲存系統中的替換啟動媒體上重新安裝ONTAP 。
