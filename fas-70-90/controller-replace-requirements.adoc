...
summary: 在更換 FAS70 或 FAS90 系統中的控制器之前，請確保您滿足成功更換所需的要求。這包括驗證系統中的所有其他元件是否正常運作，確認您擁有正確的更換控制器，以及將控制器的主控台輸出儲存至文字記錄檔。 
---
...
[role="lead"]
在更換 FAS70 或 FAS90 系統中的控制器之前，請確保您滿足成功更換所需的要求。這包括驗證系統中的所有其他元件是否正常運作，確認您擁有正確的更換控制器，以及將控制器的主控台輸出儲存至文字記錄檔。
