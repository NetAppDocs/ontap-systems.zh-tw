...
[role="lead"]
以下是 FAS90 儲存系統在單一高可用性配對中的部分規格。請造訪 NetApp Hardware Universe （HWU） 以取得此儲存系統的完整規格。
...
* 重量：59.5磅，27.0公斤
* 高度：2U
* 寬度：19 英寸，符合 IEC 機架標準（17.7 英寸，44.9 厘米）
* 深度：30.0吋（有線纜管理支架時為35.2吋）
...
* 聲學噪音：標稱聲功率 (LwAd)：8.5；聲壓 (LpAm)（旁觀者位置）：67.7 分貝
