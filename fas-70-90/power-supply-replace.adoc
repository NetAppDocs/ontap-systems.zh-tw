...
summary: 當 FAS70 或 FAS90 系統發生故障或故障時，請更換 FAS70 或 FAS90 系統中的 AC 或 DC 電源供應器（ PSU ），以確保您的系統能繼續接收所需的電力，以便穩定運作。更換程序包括中斷目標 PSU 與電源的連接，拔下電源線，移除故障 PSU ，安裝更換 PSU ，然後將其重新連接至電源。 
---
= 更換電源供應器- FAS70和FAS90
:allow-uri-read: 
:icons: font
...
[role="lead"]
當 FAS70 或 FAS90 系統發生故障或故障時，請更換 FAS70 或 FAS90 系統中的 AC 或 DC 電源供應器（ PSU ），以確保您的系統能繼續接收所需的電力，以便穩定運作。更換程序包括中斷目標 PSU 與電源的連接，拔下電源線，移除故障 PSU ，安裝更換 PSU ，然後將其重新連接至電源。
