...
summary: 如果 FAS70 或 FAS90 儲存系統中的某個乙太網路 I/O 模組發生故障，且您的儲存系統符合所有 ONTAP 版本要求，則可以熱交換模組。 
---
= 在不關機的情況下，熱插拔 FAS70 或 FAS90 系統中的 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果 FAS70 或 FAS90 儲存系統中的某個乙太網路 I/O 模組發生故障，且您的儲存系統符合所有 ONTAP 版本要求，則可以熱交換模組。
...
* 熱交換過程中，請確保將命令套用至正確的控制器和 I/O 插槽：
+
