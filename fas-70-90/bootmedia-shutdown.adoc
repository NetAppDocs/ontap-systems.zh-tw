...
summary: 需要更換開機媒體時，請關閉 FAS70 或 FAS90 儲存系統中的控制器。在執行維護或元件更換之前，請務必安全關閉控制器，以避免資料遺失並確保系統穩定性。 
---
= 關閉控制器以更換開機媒體： FAS70 和 FAS90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
需要更換開機媒體時，請關閉 FAS70 或 FAS90 儲存系統中的控制器。在執行維護或元件更換之前，請務必安全關閉控制器，以避免資料遺失並確保系統穩定性。
