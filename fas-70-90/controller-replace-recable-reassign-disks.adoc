...
summary: 將儲存資源的控制權歸還更換控制器，讓 FAS70 或 FAS90 系統恢復正常運作。 
---
= 將 FAS70 或 FAS90 系統中的控制器歸還，即可恢復正常運作。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將儲存資源的控制權歸還更換控制器，讓 FAS70 或 FAS90 系統恢復正常運作。復原過程會根據系統使用的加密類型而有所不同：無加密或板載金鑰管理員 (OKM) 加密。
