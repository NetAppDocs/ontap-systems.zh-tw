...
summary: 此工作流程使用 USB 磁碟機將 ONTAP 重新安裝到 FAS70 或 FAS90 系統中的替換開機媒體上。從 NetApp 支援網站下載適當的 ONTAP 恢復映像，將其複製到 USB 磁碟機，並使用它將系統還原至運作狀態。 
---
= 使用手冊開機恢復流程的 FAS70 和 FAS90 開機媒體更換工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
此工作流程使用 USB 磁碟機將 ONTAP 重新安裝到 FAS70 或 FAS90 系統中的替換開機媒體上。從 NetApp 支援網站下載適當的 ONTAP 恢復映像，將其複製到 USB 磁碟機，並使用它將系統還原至運作狀態。
