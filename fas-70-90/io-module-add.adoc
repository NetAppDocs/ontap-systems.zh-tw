...
summary: 在您的 FAS70 或 FAS90 系統中新增 I/O 模組，以增強網路連接並擴充系統處理資料流量的能力。 
---
= 為 FAS70 或 FAS90 系統新增 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在您的 FAS70 或 FAS90 系統中新增 I/O 模組，以增強網路連接並擴充系統處理資料流量的能力。

當 FAS70 或 FAS90 儲存系統有空插槽可用，或所有插槽均已佔滿時，您可以為其新增 I/O 模組。
