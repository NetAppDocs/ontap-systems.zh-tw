...
---
= 監控 DS212C、DS224C 或 DS460C 機櫃 LED
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
持續亮起黃色燈號
 a| 
一個或多個 FRU 的功能出現錯誤：磁碟架、磁碟機、IOM12、IOM12B 或 IOM12C 模組或電源。
...
啟用此 LED 功能後，操作顯示面板和兩個 IOM12、IOM12B 或 IOM12C 模組上的位置指示燈將會亮起。位置指示燈將在 30 分鐘後自動熄滅。
...
== IOM12、IOM12B 或 IOM12C 模組 LED

IOM12、IOM12B 或 IOM12C 模組上的 LED 指示燈顯示模組是否正常運作、是否準備好進行 I/O 通訊以及硬體是否有任何問題。

下表描述了與模組功能和模組上每個 SAS 連接埠功能相關的 IOM12、IOM12B 或 IOM12C 模組 LED。

IOM12、IOM12B 或 IOM12C 模組用於 DS460C、DS224C 和 DS212C 磁碟櫃。
...
持續亮起黃色燈號
 a| 
IOM12、IOM12B 或 IOM12C 模組功能：IOM12、IOM12B 或 IOM12C 模組的功能出現錯誤。
...
持續亮藍燈
 a| 
系統管理員啟用此 LED 功能，以協助實體定位發生故障的 IOM12、IOM12B 或 IOM12C 模組所在的磁碟櫃。
...
image::../media/drw_iom12.gif[IOM12 模組,828px,147px]

IOM12B模組以藍色等量磁碟區和「IOM12B」標籤加以區分：

image::../media/iom12b.png[IOM12B 模組,828px,147px]

IOM12C 模組以藍灰色條紋和「IOM12C」標籤為特徵：

image::../media/drw_iom12c_ieops-2175.svg[IOM12C 模組,828px,147px]
