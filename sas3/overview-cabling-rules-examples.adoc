...
summary: 以下 SAS 佈線規則、範例和工作表可協助您將具有 IOM12、IOM12B 或 IOM12C 模組的 SAS 磁碟機架連接到您的儲存系統。 
---
= DS212C、DS224C 或 DS460C 佈線規則概述
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
為了協助您將具有 IOM12、IOM12B 或 IOM12C 模組的 SAS 磁碟機櫃連接到儲存系統，您可以視需要使用任何可用的 SAS 纜線規則、工作表和範例內容。
