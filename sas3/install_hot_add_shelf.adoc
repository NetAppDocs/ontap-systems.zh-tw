...
** 在具有30個磁碟機的磁碟櫃中、其餘10個磁碟機會平均分佈在每個磁碟櫃的插槽1和10中。下圖顯示磁碟機如何在磁碟櫃內的每個磁碟機匣中編號0至11。插槽0、3、6、9及 在包含30個磁碟機的機櫃中、每個抽屜的插槽1和10必須包含磁碟機。
...
+
如果您的系統具有內部磁碟櫃、則內部磁碟櫃和外部附加磁碟櫃的磁碟櫃ID必須是唯一的。
