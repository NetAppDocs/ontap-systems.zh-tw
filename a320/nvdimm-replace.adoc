...
summary: 當系統偵測到快閃記憶體壽命即將耗盡或偵測到的 NVDIMM 記憶體條發生故障時，請更換 AFF A320 控制器模組中的 NVDIMM 記憶體條。未更換故障的 NVDIMM 記憶體條可能會導致系統崩潰。 
---
= 更換 AFF A320 系統中的 NVDIMM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當您的 AFF A320 系統偵測到快閃記憶體壽命即將耗盡或偵測到的 NVDIMM 發生故障時，請更換該 NVDIMM。未更換故障的 NVDIMM 可能會導致系統崩潰。
