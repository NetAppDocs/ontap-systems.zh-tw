...
summary: 您必須從 USB 隨身碟啟動ONTAP映像，還原檔案系統，並驗證環境變數。AFF A320系統僅支援手動啟動媒體復原程式。不支援自動啟動媒體恢復。 
---
= 在您的 AFF A320 系統上開機恢復映像
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您必須從 USB 隨身碟啟動ONTAP映像，還原檔案系統，並驗證環境變數。AFF A320系統僅支援手動啟動媒體復原程式。不支援自動啟動媒體恢復。
