...
summary: 若要將 AFF A320 系統恢復至完整運作狀態，請視需要還原 NetApp Storage Encryption 組態、安裝新控制器的授權、並將故障零件退回 NetApp。 
---
= 完成 AFF A320 系統的控制器更換工作
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
完成 AFF A320 系統的控制器更換，方法是還原 NetApp 儲存加密組態（如有必要），安裝新控制器的授權，並將故障零件退回 NetApp。
