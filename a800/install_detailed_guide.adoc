...
.步驟
. 使用動畫（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=edc42447-f721-4cbe-b080-ab0c0123a139["連接雙節點無交換器叢集"^]）或完成控制器與交換器之間佈線的逐步指示：
+
[cols="10,90"]
|===
| 步驟 | 在每個控制器模組上執行 
...
.步驟
. 使用動畫（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=49e48140-4c5a-4395-a7d7-ab0c0123a10e["交換式叢集的佈線"^]）或完成控制器與交換器之間佈線的逐步指示：
+
[cols="10,90"]
|===
| 步驟 | 在每個控制器模組上執行 
...
.步驟
. 使用動畫（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=09dade4f-00bd-4d41-97d7-ab0c0123a0b4["將控制器連接至單一磁碟機櫃"^] 或是將控制器模組纜線連接至單一機櫃的逐步指示。
+
[cols="10,90"]
|===
| 步驟 | 在每個控制器模組上執行 
...
.步驟
. 請使用下列動畫（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=fe50ac38-9375-4e6b-85af-ab0c0123a0e0["將控制器連接至兩個磁碟機櫃"^]）或將控制器連接至兩個磁碟機櫃的書面步驟。
+
[cols="10,90"]
|===
| 步驟 | 在每個控制器模組上執行 
...
. 請使用下列動畫（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=d61f983e-f911-4b76-8b3a-ab1b0066909b["將筆記型電腦連接至管理交換器"^]）將筆記型電腦連接至管理交換器。
. 選取ONTAP 列出的功能表圖示以探索：
+
