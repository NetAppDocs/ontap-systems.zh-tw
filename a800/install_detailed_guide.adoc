...
.步驟
. 使用動畫或表格步驟完成控制器與交換器之間的佈線：影片：edc42447 - f721-4cbe-b080-ab0123a139[panopto、title="Cable a雙節點無交換器叢集]
+
[cols="10,90"]
|===
| 步驟 | 在每個控制器模組上執行 
...
.步驟
. 請使用動畫或表格步驟完成控制器與交換器之間的佈線：影片：：49e48140-4c5a-43955-a7d7-ab0123a10e[panopto、title=交換式叢集的佈線]
+
[cols="10,90"]
|===
| 步驟 | 在每個控制器模組上執行 
