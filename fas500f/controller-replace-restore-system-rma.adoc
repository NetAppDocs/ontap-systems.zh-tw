...
summary: 若要完成 FAS500f 系統的控制器更換，如有必要，請還原 NetApp 儲存加密組態、安裝新控制器的授權、並將故障零件退回 NetApp。 
---
= 完整控制器更換 - FAS500f
:allow-uri-read: 
:icons: font
...
[role="lead"]
要完成 FAS500f 系統的控制器更換並使其完全運行，您必須恢復 NetApp 儲存加密配置（如有必要），並為新控制器安裝許可證，然後按照套件附帶的 RMA 說明將故障部件退回 NetApp。
