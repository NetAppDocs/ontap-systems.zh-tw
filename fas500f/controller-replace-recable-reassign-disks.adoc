...
summary: 將儲存資源的控制權交還給替換控制器，以便您的 FAS500f 系統能夠恢復正常運作。 
---
= 將 FAS500f 系統中的控制器交還，以恢復正常運作。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將儲存資源的控制交還給替換控制器，以便您的 FAS500f 系統能夠恢復正常運作。恢復並驗證系統組態後，重新連接系統線纜並重新分配磁碟機。
...
.接下來呢？
重新連接系統線纜並重新分配磁碟後、您需要link:controller-replace-restore-system-rma.html["完成控制器更換"]。
