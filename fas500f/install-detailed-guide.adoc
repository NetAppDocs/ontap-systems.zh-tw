...
image:../media/icon_square_1_green.png["步驟1."]
 a| 
使用 25 GbE 叢集互連纜線將叢集互連連接埠彼此連接起來
...
image:../media/icon_square_1_blue.png["編號 1"]
 a| 
將控制器A纜線連接至機櫃：    image:../media/drw_affa250_1shelf_cabling_a.png["控制器 A 纜線"]
...
image:../media/icon_square_2_yellow.png["編號 2"]
 a| 
將控制器B纜線連接至機櫃：    image:../media/drw_affa250_1shelf_cabling_b.png["控制器 B 纜線"]
