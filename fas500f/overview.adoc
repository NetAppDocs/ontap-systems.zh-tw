...
[role="lead"]
查看 FAS500f 儲存系統的部分規格，這些規格反映了單一高可用性配對的效能。請造訪 https://hwu.netapp.com["NetApp Hardware Universe"^]（HWU）以取得 FAS500f 的完整規格清單。
