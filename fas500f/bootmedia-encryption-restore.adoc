...
summary: 檢查完環境變數後，您必須完成已啟用 Onboard Key Manager OKM、NetApp Storage Encryption NSE 或 NetApp Volume Encryption NVE 的系統的特定步驟。 
---
= 手動開機恢復程序完成後，還原 FAS500f 系統中開機媒體上的加密。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更換開機媒體後，如果您的 FAS500f 系統使用 Onboard Key Manager、NetApp Storage Encryption 或 NetApp Volume Encryption 來保護您的資料，請還原加密。
