...
summary: FAS500f 系統中的開機媒體儲存重要的韌體和組態資料。更換程序包括移除控制器模組、移除受損的開機媒體、在控制器模組中安裝替換的開機媒體，然後重新安裝控制器模組。 
---
= 更換用於自動開機還原的開機媒體 - FAS500f
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS500f 系統中的開機媒體儲存重要的韌體和組態資料。更換程序包括移除並開啟控制器模組、移除受損的開機媒體、在控制器模組中安裝替換的開機媒體、然後重新安裝控制器模組。
