...
summary: FAS500f 系統中的開機媒體儲存著重要的韌體和組態資料。更換開機媒體需要拆下控制器模組、取出受損的開機媒體、安裝替換的開機媒體，然後重新安裝控制器模組。 
---
= 使用自動開機恢復流程更換 FAS500f 系統中的開機媒體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
FAS500f 系統中的開機媒體儲存著重要的韌體和組態資料。更換開機媒體需要拆下控制器模組、取出受損的開機媒體、安裝替換的開機媒體，然後重新安裝控制器模組。
