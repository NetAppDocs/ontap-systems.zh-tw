...
summary: 將儲存資源的控制權交還給替換控制器，以便您的 ASA A800 系統能夠恢復正常運作。 
---
= 將控制器交還給您的 ASA A800 系統，以恢復正常運作。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將儲存資源的控制權交還給替換控制器，以便您的ASA A800系統能夠恢復正常運作。返還過程會根據您系統使用的加密類型而有所不同：無加密或板載密鑰管理器 (OKM) 加密。
