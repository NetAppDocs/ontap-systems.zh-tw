...
[role="lead"]
選擇您喜歡的 ASA A250 儲存系統安裝格式：詳細的逐步說明、快速圖形指南或影片說明。

* link:../asa250/install-quick-guide.html["快速步驟"]
+
可列印的PDF逐步說明、並提供其他內容的即時連結。

* link:../asa250/install-videos.html["影片步驟"]
+
視訊逐步指示。

* link:../asa250/install-detailed-guide.html["詳細步驟"]
+
線上逐步指示、並提供其他內容的即時連結。
