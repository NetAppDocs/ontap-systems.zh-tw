...
summary: 若要開始更換 ASA A250 儲存系統中的開機媒體，請先檢閱更換需求、關閉控制器、更換開機媒體、還原開機媒體上的映像，並驗證系統功能。 
---
= 使用自動化開機恢復流程的 ASA A250 開機媒體更換工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
啟動映像的自動復原過程包括系統自動辨識並選擇對應的啟動選單選項。它使用夥伴節點上的啟動映像，將 ONTAP 重新安裝到 ASA A250 儲存系統中的替換啟動媒體上。
