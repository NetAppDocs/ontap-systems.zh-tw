...
summary: 要更換 ASA C250 系統中的 NVMEM 電池，必須從系統中移除控制器模組、開啟它、更換電池，然後結案並重新裝回控制器模組。 
---
= 更換 ASA C250 系統中的 NVMEM 電池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
要更換 ASA C250 系統中的 NVMEM 電池，必須從系統中移除控制器模組、開啟它、更換電池，然後結案並重新裝回控制器模組。
