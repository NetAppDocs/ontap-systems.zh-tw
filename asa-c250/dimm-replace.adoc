...
summary: 當 ASA C250 系統偵測到越來越多的可修正錯誤更正碼或不可修正的 ECC 錯誤時，請更換系統中的 DIMM 記憶體條。未更換故障 DIMM 記憶體條可能會導致系統崩潰。 
---
= 更換 ASA C250 系統中的 DIMM 以修復記憶體容量錯誤
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當 ASA C250 系統偵測到越來越多的可修正錯誤更正碼或不可修正的 ECC 錯誤時，請更換系統中的 DIMM 記憶體條。未更換故障 DIMM 記憶體條可能會導致系統崩潰。
