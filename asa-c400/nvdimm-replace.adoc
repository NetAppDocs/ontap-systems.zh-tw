...
summary: 當系統偵測到快閃記憶體壽命即將耗盡或偵測到已識別的 NVDIMM 記憶體條發生故障時，必須更換控制器模組中的 NVDIMM 記憶體條。否則會導致系統異常。 
---
= 更換 ASA C400 系統中的 NVDIMM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當儲存系統遇到過多的可修正 ECC 錯誤或不可修正 ECC 錯誤時，請更換 ASA C400 系統中的 NVDIMM，這些錯誤通常是由單一 NVDIMM 故障所引起的。
...
image::../media/drw_A400_Replace-NVDIMM-DIMM_IEOPS-1009.svg[更換 NVDIMM]
