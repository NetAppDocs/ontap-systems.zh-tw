...
summary: 更換 ASA C400 控制器模組中的即時時鐘電池，以確保依賴精確時間同步的服務和應用程式能夠繼續運作。 
---
= 更換 ASA C400 系統中的 RTC 電池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
透過更換控制器模組中的 RTC 電池，還原 ASA C400 系統的精確時間同步。
...
+
image::../media/drw_c400_remove_controller_IEOPS-1216.svg[卸下控制器模組]
...
image::../media/drw_c400_rtc_batt_IEOPS-1239.svg[取出 RTC 電池]
