...
summary: 若要更換 ASA C400 儲存系統中的控制器、請關閉受損的控制器、移除並更換控制器、還原系統組態、然後將儲存資源的控制權交還給更換後的控制器。 
---
= 控制器更換工作流程 - ASA C400
:allow-uri-read: 
:icons: font
...
[role="lead"]
若要更換 ASA C400 儲存系統中的控制器、請關閉受損的控制器、移除並更換控制器、還原系統組態、然後將儲存資源的控制權交還給更換後的控制器。
