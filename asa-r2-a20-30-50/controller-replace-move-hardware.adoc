...
summary: 當硬體故障需要更換ASA A20、 ASA A30 或ASA A50 儲存系統中的控制器。更換過程包括移除受損的控制器、將組件移至更換的控制器、安裝更換的控制器以及重新啟動它。 
---
= 更換 ASA A20、ASA A30 或 ASA A50 系統中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當硬體故障需要更換ASA A20、 ASA A30 或ASA A50 儲存系統中的控制器。更換過程包括移除受損的控制器、將組件移至更換的控制器、安裝更換的控制器以及重新啟動它。
