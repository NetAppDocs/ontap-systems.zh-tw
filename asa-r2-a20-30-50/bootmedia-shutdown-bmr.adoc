...
summary: 更換開機媒體時，請關閉 ASA A20、ASA A30 或 ASA A50 儲存系統中的控制器，以防止資料遺失並確保系統穩定性。 
---
...
[role="lead"]
更換開機媒體時，請關閉 ASA A20、ASA A30 或 ASA A50 儲存系統中的控制器，以防止資料遺失並確保系統穩定性。
...
.下一步
關閉控制器後，您link:bootmedia-replace-bmr.html["更換開機媒體"]。
