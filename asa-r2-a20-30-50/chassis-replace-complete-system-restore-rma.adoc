...
summary: 驗證機箱的 HA 狀態，然後將故障零件退回 NetApp ，以完成 ASA A20 ， ASA A30 和 ASA A50 機箱更換程序的最後步驟。 
---
= 完成 ASA A20、ASA A30 或 ASA A50 系統的機箱更換
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
驗證機箱的 HA 狀態，然後將故障零件退回 NetApp ，以完成 ASA A20 ， ASA A30 和 ASA A50 機箱更換程序的最後步驟。
