...
summary: 當磁碟機發生故障或需要升級時，請更換ASA A20、 ASA A30 或ASA A50 儲存系統中的磁碟機。更換過程包括識別故障磁碟機、安全移除它以及安裝新磁碟機以確保持續的資料存取和系統效能。 
---
= 在 ASA A20、ASA A30 或 ASA A50 系統中熱交換磁碟機
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當磁碟機發生故障或需要升級時，請更換ASA A20、 ASA A30 或ASA A50 儲存系統中的磁碟機。更換過程包括識別故障磁碟機、安全移除它以及安裝新磁碟機以確保持續的資料存取和系統效能。

在 I/O 操作進行期間，您可以無中斷地熱插拔磁碟機。
