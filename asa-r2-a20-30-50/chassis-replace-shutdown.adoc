...
summary: 關閉 ASA A20 ， ASA A30 或 ASA A50 儲存系統中的控制器，以防止資料遺失，並確保更換機箱時系統穩定。 
---
= 更換機箱時，請關閉 ASA A20、ASA A30 或 ASA A50 控制器。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉 ASA A20 ， ASA A30 或 ASA A50 儲存系統中的控制器，以防止資料遺失，並確保更換機箱時系統穩定。
