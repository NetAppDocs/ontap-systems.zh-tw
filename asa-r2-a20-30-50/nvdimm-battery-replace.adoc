...
summary: 當電池開始充電或故障時，請更換 ASA A20 ， ASA A30 或 ASA A50 系統中的 NV 電池，因為它負責在停電期間保留重要的系統資料。 
---
...
[role="lead"]
當電池開始充電或故障時，請更換 ASA A20 ， ASA A30 或 ASA A50 系統中的 NV 電池，因為它負責在停電期間保留重要的系統資料。更換程序包括關閉受損的控制器，移除控制器模組，更換 NV 電池，重新安裝控制器模組，以及將故障零件退回 NetApp 。
