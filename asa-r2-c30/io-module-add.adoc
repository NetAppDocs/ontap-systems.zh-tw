...
summary: 在您的 ASA C30 儲存系統中新增 I/O 模組以增強網路連線並擴展系統處理資料流量的能力。 
---
= 在 ASA C30 系統新增 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在您的 ASA C30 儲存系統中新增 I/O 模組以增強網路連線並擴展系統處理資料流量的能力。

如果有可用插槽，您可以為 ASA C30 儲存系統新增 I/O 模組。如果所有插槽都已填滿，則可以取代現有模組以新增模組。
