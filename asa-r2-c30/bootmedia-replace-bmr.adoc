...
summary: ASA C30 儲存系統中的啟動媒體儲存了必要的韌體和設定資料。更換程序包括移除控制器模組，移除受損的開機媒體，安裝更換的開機媒體，然後將 ONTAP 映像傳輸至更換的開機媒體。 
---
= 使用自動開機恢復流程更換 ASA C30 系統中的開機媒體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ASA C30 儲存系統中的啟動媒體儲存了必要的韌體和設定資料。更換程序包括移除控制器模組，移除受損的開機媒體，安裝更換的開機媒體，然後將 ONTAP 映像傳輸至更換的開機媒體。
