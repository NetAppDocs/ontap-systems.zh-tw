...
summary: 如果 ASA C30 儲存系統中的乙太網路 I/O 模組發生故障，您可以熱插拔該模組，前提是您的儲存系統符合所有 ONTAP 版本要求。 
---
= 在不關機的情況下，熱交換 ASA C30 系統中的 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果 ASA C30 儲存系統中的乙太網路 I/O 模組發生故障，您可以熱插拔該模組，前提是您的儲存系統符合所有 ONTAP 版本要求。
