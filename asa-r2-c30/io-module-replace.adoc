...
summary: 當模組發生故障或需要升級以支援更高的效能或附加功能時，請更換 ASA C30 儲存系統中的 I/O 模組。更換程序包括關閉控制器，更換故障 I/O 模組，重新啟動控制器，以及將故障零件退回 NetApp 。 
---
= 更換 ASA C30 系統中的 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當模組發生故障或需要升級以支援更高的效能或附加功能時，請更換 ASA C30 儲存系統中的 I/O 模組。更換程序包括關閉控制器，更換故障 I/O 模組，重新啟動控制器，以及將故障零件退回 NetApp 。
