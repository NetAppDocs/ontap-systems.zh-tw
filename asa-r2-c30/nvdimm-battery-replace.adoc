...
summary: 當電池開始失去電量或故障時，請更換 ASA C30 儲存系統中的 NV 電池，因為它負責在停電期間保存關鍵系統資料。更換程序包括關閉受損的控制器，移除控制器模組，更換 NV 電池，重新安裝控制器模組，以及將故障零件退回 NetApp 。 
---
= 更換 ASA C30 系統中的 NV 電池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當電池開始失去電量或故障時，請更換 ASA C30 儲存系統中的 NV 電池，因為它負責在停電期間保存關鍵系統資料。更換程序包括關閉受損的控制器，移除控制器模組，更換 NV 電池，重新安裝控制器模組，以及將故障零件退回 NetApp 。
