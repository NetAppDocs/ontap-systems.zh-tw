...
HA配對
 a| 
link:controller_replace_complete_system_restoration.md#["驗證HA系統上的系統ID變更"]
...
獨立式
 a| 
link:controller_replace_complete_system_restoration.md#["在ONTAP 支援的獨立系統上手動重新指派系統ID"]
...
雙節點MetroCluster 的不全功能組態
 a| 
link:controller_replace_complete_system_restoration.md#["在雙節點MetroCluster 的作業系統上手動重新指派系統ID"]
