...
summary: 更換 FAS8300 或 FAS8700 儲存系統中的控制器時，請關閉控制器以防止資料遺失並確保系統穩定性。 
---
= 在更換之前、請先關閉 FAS8300 或 FAS8700 系統中發生故障的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更換 FAS8300 或 FAS8700 儲存系統中的控制器時，請關閉控制器以防止資料遺失並確保系統穩定性。
...
====
.接下來呢？
關閉 FAS8300 和 FAS8700 控制器後，您需要link:controller-replace-move-hardware.html["更換控制器"]。
