...
---
= 更換 FAS8300 或 FAS8700 系統中的 PCIe 卡或夾層卡
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:../media/drw_A400_Replace-PCIe-cards.png["卸下 PCIe 卡"]
...
. 將替換的 PCIe 卡安裝到轉接卡中，方法是將卡片與插槽對齊，將卡片壓入插槽，然後關閉轉接卡的側面板（如果有）。
+
...
image::../media/drw_A400_Replace-mezz-card.png[卸下夾層卡]
