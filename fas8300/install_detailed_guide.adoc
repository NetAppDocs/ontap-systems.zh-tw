...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=80c4701e-8e4a-408e-96e6-ab1b00666d3f["雙節點無交換式叢集纜線"]

+
image::../media/drw_fas8300_TNSC_network_cabling.png[DRW fas8300 TSC網路纜線]
...
. 請使用動畫或圖例來完成控制器與交換器之間的佈線：
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=5893b7d4-6f67-4a64-ad89-ab1b006658d1["交換式叢集纜線"]

+
image::../media/drw_fas8300_switched_network_cabling.png[DRW fas8300交換式網路纜線]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=46c0da0b-6842-449f-b28c-ab1b0066584b["將控制器連接至SAS磁碟機櫃"]

+
image::../media/drw_fas8300_three-ds224c_shelves.png[DRW fas8300三個ds224c磁碟櫃]
