...
summary: 在雙節點 MetroCluster 組態中完成 FRU 更換後、您可以執行 MetroCluster 切換回復作業。這會將組態恢復至正常運作狀態、先前受損站台上的同步來源儲存虛擬機器現在處於作用中狀態、並從本機磁碟集區提供資料。 
---
= 切換雙節點 MetroCluster 組態中的集合體，適用於您的 FAS8300 或 FAS8700 系統
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
