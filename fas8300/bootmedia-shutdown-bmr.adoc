...
summary: 更換開機媒體時，請關閉 FAS8300 或 FAS8700 儲存系統中的控制器，以防止資料遺失並確保系統穩定性。 
---
= 在自動開機恢復過程中，關閉 FAS8300 或 FAS8700 系統中的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更換開機媒體時，請關閉 FAS8300 或 FAS8700 儲存系統中的控制器，以防止資料遺失並確保系統穩定性。
