...
summary: 關閉FAS8300或FAS8700儲存系統中受損的控制器，以防止資料遺失並確保更換啟動媒體時系統穩定性。 
---
= 在自動開機恢復過程中，關閉 FAS8300 或 FAS8700 系統中發生故障的控制器。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉FAS8300或FAS8700儲存系統中受損的控制器，以防止資料遺失並確保更換啟動媒體時系統穩定性。
