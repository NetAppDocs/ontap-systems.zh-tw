...
[role="lead"]
更換系統DIMM需要透過相關的錯誤訊息來識別目標DIMM、使用通風管上的FRU對應圖或主機板上亮起的LED來找出目標DIMM、然後更換DIMM。
...
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=175c6597-449e-4dc8-8c02-aad9012f08b5["更換系統DIMM"]

image::../media/drw_A400_Replace-NVDIMM-DIMM.png[DRW A400更換NVDIMM DIMM]

系統中的DIMM數量和位置取決於系統機型。如需詳細資訊、請參閱通風管上的FRU對應圖。
...
** 如果測試報告無故障、請從功能表中選取「重新開機」以重新啟動系統。
