...
summary: 透過查看更換需求、檢查加密狀態、關閉控制器、更換啟動媒體、啟動復原映像、復原加密以及驗證系統功能，開始更換FAS8300儲存系統中的啟動媒體。 
---
= 啟動介質手動復原工作流程 - FAS8300 和 FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
透過查看更換需求、檢查加密狀態、關閉控制器、更換啟動媒體、啟動復原映像、復原加密以及驗證系統功能，開始更換FAS8300儲存系統中的啟動媒體。
