...
summary: 維護好您的 FAS8300 或 FAS8700 儲存系統的硬體，以確保其長期可靠性和最佳效能。定期執行維護任務，例如更換故障組件，這有助於防止停機和資料遺失。 
---
= 了解如何維護您的 FAS8300 或 FAS8700 儲存系統
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
維護好您的 FAS8300 或 FAS8700 儲存系統的硬體，以確保其長期可靠性和最佳效能。定期執行維護任務，例如更換故障組件，這有助於防止停機和資料遺失。

維修過程假定FAS8300和FAS8700儲存系統已部署為ONTAP環境中的儲存節點。
...
對於FAS8300和FAS8700儲存系統，您可以對下列元件執行維護程序。
