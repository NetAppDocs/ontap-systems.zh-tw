...
summary: 完成 FAS8300 或 FAS8700 系統的控制器更換。安裝替換控制器的授權，確認邏輯介面 （LIF） 已向其主連接埠報告，並執行叢集資訊健檢。最後，將故障零件退回 NetApp。 
---
= 完成 FAS8300 或 FAS8700 系統的控制器更換
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
完成 FAS8300 或 FAS8700 系統的控制器更換。安裝替換控制器的授權，確認邏輯介面 （LIF） 已向其主連接埠報告，並執行叢集資訊健檢。最後，將故障零件退回 NetApp。
