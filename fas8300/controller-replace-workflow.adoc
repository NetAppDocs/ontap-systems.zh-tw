...
summary: 若要更換 FAS8300 或 FAS8700 儲存系統中的控制器、請關閉故障控制器、移除並更換控制器、還原系統組態、並將儲存資源的控制權交還給更換後的控制器。 
---
= 控制器更換工作流程 - FAS8300 和 FAS8700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
若要更換 FAS8300 或 FAS8700 儲存系統中的控制器、請關閉故障控制器、移除並更換控制器、還原系統組態、並將儲存資源的控制權交還給更換後的控制器。
