...
[role="lead"]
查看單一高可用性 (HA) 對中 FAS8700 儲存系統的部分規格，並存取 NetApp Hardware Universe (HWU) 以取得此系統的完整規格。
...
* 類型：NAS；HA 對：12；原始容量：180.0 PB / 159.9 PiB；最大記憶體：6144 GB
* 類型：SAN；HA 對：6；原始容量：90.0 PB / 79.9 PiB；最大記憶體：3072 GB
* 類型：HA 對；原始容量：15.0 PB / 13.3 PiB；最大記憶體：512.0000
