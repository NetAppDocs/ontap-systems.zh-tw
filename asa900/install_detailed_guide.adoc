...
不適用
 a| 
image:../media/oie_cable_micro_usb.svg["Micro USB 纜線"]
 a| 
...
不適用
 a| 
image:../media/oie_cable_power.svg["寬度 =85px"]
 a| 
開啟系統電源
...
| 步驟 | 在每個控制器上執行 
 ...
 a| 
image:../media/oie_legend_icon_1_lg.svg["圖說文字圖示 1"]
 a| 
纜線叢集互連連接埠：
...
image:../media/oie_cable100_gbe_qsfp28.svg["100 GB 纜線"]
 ...
 a| 
image:../media/oie_legend_icon_2_lp.svg["圖說文字圖示 2."]
 a| 
纜線控制器管理（扳手）連接埠。
...
image:../media/oie_cable_rj45.svg["RJ-45 纜線"]
 ...
 a| 
image:../media/oie_legend_icon_3_o.svg["圖說文字圖示 3."]
 a| 
纜線25 GbE網路交換器：
...
image:../media/oie_cable100_gbe_qsfp28.svg["100 GB 纜線"]
 ...
 a| 
image:../media/oie_legend_icon_4_dr.svg["圖說文字圖示 4."]
 a| 
纜線32 Gb FC連線：
...
| 步驟 | 在每個控制器上執行 
 ...
 a| 
影像： ../media/oie_legend_ical_1_lg.svg[
 a| 
纜線叢集互連A連接埠：
...
image:../media/oie_cable_pull_tab_down.svg["寬度 =200px"]
...
| 步驟 | 在每個控制器上執行 
 ...
 a| 
image:../media/oie_legend_icon_1_mb.svg["圖說文字圖示 1"]
 a| 
** 將控制器A連接埠E2A連接至機櫃上NSM A的連接埠e0a。
** 將控制器A連接埠e10b連接至機櫃NSM B上的連接埠e0b。


image:../media/oie_cable100_gbe_qsfp28.svg["寬度 =50px"]
...
100 GbE纜線
 ...
 a| 
image:../media/oie_legend_icon_2_lo.svg["圖說文字圖示 1"]
 a| 
...
100 GbE纜線
 ...
 a| 
image:../media/oie_legend_icon_2_lo.svg["寬度 =30px"]
 a| 
...
機櫃ID LED
 ...
 a| 
image:../media/legend_icon_04.svg["寬=20"]
 a| 
機櫃ID設定按鈕
...
+
影像： [ 標註圖示一 ] drw_A900_POWER-on_IEOS-941.svg [width=500px]
