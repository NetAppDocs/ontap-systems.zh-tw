...
summary: 當您的 ASA C800 系統中的交流或直流電源單元發生故障或損壞時，請更換該電源單元，以確保您的系統繼續獲得穩定運作所需的電力。 
---
= 在 ASA C800 系統中熱插拔電源供應
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當您的ASA C800系統中的交流或直流電源單元 (PSU) 發生故障或故障時，請更換此電源單元，以確保您的系統繼續獲得穩定運作所需的電力。更換過程包括：斷開故障電源與電源的連接，拔下電源線，更換故障電源，然後將其重新連接到電源。
...
+
image::../media/drw_a800_replace_psu.svg[移除或重新啟動 PSU]
