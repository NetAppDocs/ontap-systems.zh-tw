...
summary: 當您需要更換開機媒體時，請關閉 AFF A70 或 AFF A90 儲存系統中的控制器。在執行維護或元件更換之前，請務必安全關閉控制器，以避免資料遺失並確保系統穩定性。 
---
= 關閉控制器以更換開機媒體 - AFF A70 和 AFF A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當您需要更換開機媒體時，請關閉 AFF A70 或 AFF A90 儲存系統中的控制器。在執行維護或元件更換之前，請務必安全關閉控制器，以避免資料遺失並確保系統穩定性。
