...
summary: 當 AFF A70 或 AFF A90 系統發生故障或韌體毀損時，請更換系統管理模組。更換程序包括關閉受損的控制器，更換故障的系統管理模組，重新啟動控制器，更新授權金鑰，以及將故障零件退回 NetApp 。 
---
= 更換 AFF A70 或 AFF A90 系統中的系統管理模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當 AFF A70 或 AFF A90 系統發生故障或韌體毀損時，請更換系統管理模組。更換程序包括關閉控制器，更換故障的系統管理模組，重新啟動控制器，更新授權金鑰，以及將故障零件退回 NetApp 。
...
WARNING: 系統管理模組不支援熱插拔。更換前，請重新安裝硬碟，關閉節點，拔掉控制器電源，並將控制器從機殼中拉出幾英寸。
