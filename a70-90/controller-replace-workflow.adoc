...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["四"]link:controller-replace-recable-reassign-disks.html["可重新分配控制器"]
[role="quick-margin-para"]
