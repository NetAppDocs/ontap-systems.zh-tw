...
summary: 關閉 AFF A70 或 AFF A90 儲存系統中的控制器，以防止資料遺失，並確保更換機箱時系統穩定。 
---
= 更換機箱時，請關閉 AFF A70 或 AFF A90 控制器。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉 AFF A70 或 AFF A90 儲存系統中的控制器，以防止資料遺失，並確保更換機箱時系統穩定。
...
.接下來呢？
關閉控制器後，link:chassis-replace-move-hardware.html["更換機箱"] 。
