...
summary: 當您的 AFF A70 或 AFF A90 系統中的交流電或直流電源供應器故障或發生故障時，請更換電源供應器，以確保系統持續獲得穩定運作所需的電力。更換過程包括：斷開故障 PSU 與電源的連接、拔除電源線、更換故障 PSU，然後重新連接電源。 
---
= 在 AFF A70 或 AFF A90 系統中熱交換的電源供應單元
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
