...
summary: 關閉 AFF A70 或 AFF A90 儲存系統中的控制器，以防止資料遺失，並確保更換控制器時系統穩定。 
---
= 更換 AFF A70 或 AFF A90 系統中發生故障的控制器之前，請先將其關閉。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉 AFF A70 或 AFF A90 儲存系統中的控制器，以防止資料遺失，並確保更換控制器時系統穩定。
