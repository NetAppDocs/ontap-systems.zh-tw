...
* 如果已啟用NSE或NVE、且已啟用Onboard Key Manager、請前往 <<Option 1: Restore NVE or NSE when Onboard Key Manager is enabled>>。
* 如果NSE或NVE已啟用ONATP 9.5、請前往 <<Option 2: Restore NSE/NVE on systems running ONTAP 9.5 and earlier>>。
* 如果NSE或NVE已啟用ONTAP 支援功能以支援S69.6、請前往 <<Option 3: Restore NSE/NVE on systems running ONTAP 9.6 and later>>。
