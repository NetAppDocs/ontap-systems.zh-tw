...
summary: 更換AFF A700s控制器模組上故障的啟動介質。AFF A700s系統僅支援手動啟動媒體復原程式。不支援自動啟動媒體恢復。 
---
= 更換 AFF A700s 系統中的開機媒體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更換AFF A700s控制器模組上故障的啟動介質。此程序包括從機箱中取出控制器模組，使用點亮的 LED 指示燈找到故障的啟動介質，物理更換啟動介質組件，並將系統恢復到正常運作狀態。
