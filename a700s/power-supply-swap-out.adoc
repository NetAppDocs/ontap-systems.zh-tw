...
summary: 在您的 AFF A700s 系統中更換電源供應器，方法是將目標 PSU 從電源拔除，拔下電源線，移除舊的 PSU，安裝替換的 PSU，然後重新連接到電源。 
---
= 在 AFF A700s 系統中熱插拔電源供應
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 AFF A700s 系統中，您可以透過斷開、移除和更換故障的電源供應，然後將其重新連接到電源來源，以熱插拔電源供應。
