...
summary: 關閉AFF C30 或AFF C60 儲存系統中受損的控制器，以防止資料遺失並在自動啟動媒體復原過程中保持系統穩定性。 
---
= 在自動開機恢復過程中，關閉 AFF C30 或 AFF C60 儲存系統中的控制器。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉AFF C30 或AFF C60 儲存系統中受損的控制器，以防止資料遺失並在自動啟動媒體復原過程中保持系統穩定性。
