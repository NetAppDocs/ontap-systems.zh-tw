...
summary: 在更換 AFF C30 或 AFF C60 儲存系統的機箱之前，請確保滿足成功更換的必要條件。這包括確認系統中的所有其他組件都運作正常，以及您擁有正確的替換機箱和必要的工具。 
---
= 在更換 AFF C30 或 AFF C60 系統的機箱之前，請先檢視相關要求。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更換 AFF C30 或 AFF C60 儲存系統的機箱之前，請確保滿足成功更換的必要條件。這包括確認系統中的所有其他組件都運作正常，以及您擁有正確的替換機箱和必要的工具。
