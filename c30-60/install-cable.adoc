...
summary: 安裝 AFF C30 或 AFF C60 儲存系統硬體後，請將控制器連接至網路和機櫃。 
---
= 將 AFF C30 或 AFF C60 硬體連接至網路和儲存設備。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_2card_cabling_ieops-2011.svg[使用兩個 100GbE I/O 模組的 c30 和 c60 無交換器叢集佈線圖]
...
+
image::../media/drw_isi_a30-50_switchless_2p_100gbe_1card_cabling_ieops-1925.svg[使用單一 100GbE I/O 模組的 c30 和 c60 無交換器叢集佈線圖]
...
+
image::../media/drw_isi_a30-50_switched_2p_100gbe_2card_cabling_ieops-2013.svg[使用兩個 100GbE I/O 模組的 c30 和 c60 交換式叢集佈線圖]
