...
[role="lead"]
以下是 AFF C60 儲存系統在單一 HA 配對中的部分規格。如需查看該儲存系統的完整規格，請造訪 NetApp Hardware Universe （HWU）。
...
* 類型：NAS；HA 對：4；原始容量：29.5 PB / 26.2 PiB；最大記憶體：512 GB
* 類型：SAN；HA 對：4；原始容量：29.5 PB / 26.2 PiB；最大記憶體：512 GB
* 類型：HA 對；原始容量：7.4 PB / 6.5 PiB；最大記憶體：128.0000
