...
summary: 在手動開機媒體恢復過程中，關閉 AFF C30 或 AFF C60 儲存系統中的控制器，以防止資料遺失並維持系統穩定性。 
---
= 在手動開機恢復過程中，關閉 AFF C30 或 AFF C60 儲存系統中的控制器。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在手動開機媒體恢復過程中，關閉 AFF C30 或 AFF C60 儲存系統中的控制器，以防止資料遺失並維持系統穩定性。
