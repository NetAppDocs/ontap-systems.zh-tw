...
summary: 關閉 AFF C30 或 AFF C60 儲存系統中受損的控制器，以防止資料遺失，並確保更換控制器時系統穩定性。 
---
= 更換 AFF C30 或 AFF C60 儲存系統中的受損控制器之前，請先將其關機。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉 AFF C30 或 AFF C60 儲存系統中受損的控制器，以防止資料遺失，並確保更換控制器時系統穩定性。
