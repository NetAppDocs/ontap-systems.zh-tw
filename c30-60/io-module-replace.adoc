...
summary: 當模組發生故障或需要升級以支援更高效能或附加功能時，請更換AFF C30 或AFF C60 儲存系統中的 I/O 模組。更換過程包括關閉控制器、更換故障的 I/O 模組、重新啟動控制器，以及將故障零件退回NetApp。 
---
= 更換 AFF C30 或 AFF C60 儲存系統中的 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當模組發生故障或需要升級以支援更高效能或附加功能時，請更換AFF C30 或AFF C60 儲存系統中的 I/O 模組。更換過程包括關閉控制器、更換故障的 I/O 模組、重新啟動控制器，以及將故障零件退回NetApp。
...
== 步驟 1：關閉故障 I/O 模組所在的控制器

使用下列選項之一關閉或接管具有故障 I/O 模組的控制器。
