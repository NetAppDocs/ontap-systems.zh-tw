...
summary: 單一高可用度配對中 AFF C30 和 AFF C60 儲存系統的關鍵規格 
---
= AFF C30 和 AFF C60 的主要規格
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
以下列出 AFF C30 和 AFF C60 儲存系統在單一高可用度配對中的部分規格。請造訪 https://hwu.netapp.com["NetApp Hardware Universe"^]以取得這些儲存系統的完整規格。
