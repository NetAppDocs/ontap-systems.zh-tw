...
summary: 當磁碟機發生故障或需要升級時，請更換AFF C30 或AFF C60 儲存系統中的磁碟機。更換過程包括識別故障磁碟機、安全移除它以及安裝新磁碟機以確保持續的資料存取和系統效能。 
---
= 更換 AFF C30 或 AFF C60 儲存系統中的磁碟機
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當磁碟機發生故障或需要升級時，請更換AFF C30 或AFF C60 儲存系統中的磁碟機。更換過程包括識別故障磁碟機、安全移除它以及安裝新磁碟機以確保持續的資料存取和系統效能。
