...
summary: 請查閱安裝 AFF C30 或 AFF C60 儲存系統的要求，包括所需的設備、起吊注意事項和站台規格，以便順利完成安裝。 
---
= 審查安裝 AFF C30 和 AFF C60 儲存系統的要求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
請查閱安裝 AFF C30 或 AFF C60 儲存系統的要求，包括所需的設備、起吊注意事項和站台規格，以便順利完成安裝。
