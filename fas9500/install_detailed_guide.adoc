...
X66240A-5（112-00600）、5公尺
 a| 
影像： ../media/oie_cable 、 sP_GbE 銅線 .svg
 a| 
網路纜線
...
X66100-5（112-00544）、5公尺
 a| 
影像： ../media/oie_cable100_GBE_qsfps28.svg
 a| 
乙太網路資料、叢集網路
...
影像： ../media/oie_cable100_GBE_qsfps28.svg
 ...
 a| 
影像： ../media/oie_legend_ical_2_lp.svg
 a| 
纜線控制器管理（扳手）連接埠。
...
影像： ../media/oie_cable 、 RJ45.svg
 ...
 a| 
影像： ../media/oie_legend_icler_3_o.svg
 a| 
纜線32 Gb FC網路交換器：
...
影像： ../media/oie_cable100_GBE_qsfps28.svg
 ...
 a| 
影像： ../media/oie_legend_ical_4_dr.svg
 a| 
纜線25 GbE連線：
