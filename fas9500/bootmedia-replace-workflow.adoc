...
summary: 透過查看更換需求、檢查加密狀態、關閉控制器、更換啟動媒體、啟動復原映像、恢復加密以及驗證系統功能，開始更換FAS9500儲存系統中的啟動媒體。 
---
= 啟動媒體手動復原工作流程 - FAS9500
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
透過查看更換需求、檢查加密狀態、關閉控制器、更換啟動媒體、啟動復原映像、恢復加密以及驗證系統功能，開始更換FAS9500儲存系統中的啟動媒體。
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["五"]link:bootmedia-recovery-image.html["開機恢復映像"]
[role="quick-margin-para"]
