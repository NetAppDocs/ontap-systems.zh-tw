...
summary: 當 FAS9500 系統透過 Health Monitor 警報報告過多可糾正的 ECC 記憶體容量錯誤或不可糾正的 ECC 錯誤時，請更換 DIMM。故障的 DIMM 可能導致儲存系統無法開機 ONTAP，因此更換 DIMM 可恢復系統的穩定運作。 
---
...
[role="lead"]
當 FAS9500 系統透過 Health Monitor 警報報告過多可糾正的 ECC 記憶體容量錯誤或不可糾正的 ECC 錯誤時，請更換 DIMM。故障的 DIMM 可能導致儲存系統無法開機 ONTAP，因此更換 DIMM 可恢復系統的穩定運作。
