...
summary: 透過查看更換需求、關閉控制器、更換啟動媒體、恢復啟動媒體上的映像以及驗證系統功能，開始更換FAS9500儲存系統中的啟動媒體。 
---
= 使用自動化開機恢復流程的 FAS9500 開機媒體更換工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用自動開機恢復流程，即可開始更換 FAS9500 儲存系統中的開機媒體。系統會自動辨識並選擇對應的開機功能表選項，然後使用合作夥伴節點上的開機映像，在取代的開機媒體上重新安裝 ONTAP。
