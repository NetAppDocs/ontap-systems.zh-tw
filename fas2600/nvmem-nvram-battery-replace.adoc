...
summary: 更換 FAS2600 系統中的 NVMEM 電池，方法是移除控制器模組，更換電池，然後重新安裝控制器模組。 
---
= 更換 FAS2600 系統中的 NVMEM 電池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
若要更換 FAS2600 系統中的 NVMEM 電池，請拆下控制器模組、打開它、更換電池，然後關閉並重新安裝控制器模組。

如果系統中的任何其他組件無法正常運作，請聯絡技術支援。

link:https://youtu.be/dgEMcYxya5M["FAS2600 NVMEM電池更換影片AFF"^]
