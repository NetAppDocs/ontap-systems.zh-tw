...
summary: 在 FAS9000 系統中熱插拔快取模組。從 ONTAP 9.4 開始，您可以熱插拔位於插槽 6 中 NVRAM10 模組前面的 NVMe SSD Flash Cache 模組，使用來自相同或不同支援廠商的相同容量的快取模組。 
---
= 在 FAS9000 系統中熱插拔快取模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 FAS9000 系統中熱插拔快取模組。從 ONTAP 9.4 開始，您可以熱插拔位於插槽 6 中 NVRAM10 模組前面的 NVMe SSD Flash Cache 模組，使用來自相同或不同支援廠商的相同容量的快取模組。
