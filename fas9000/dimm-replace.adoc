...
summary: 當 FAS9000 系統透過健康監視器警報報告過多可修正的 ECC 記憶體容量錯誤或不可修正的 ECC 錯誤時，請更換系統中的 DIMM 記憶體條。故障的 DIMM 記憶體條可能導致儲存系統無法開機 ONTAP，因此更換它可以恢復系統的穩定運作。 
---
= 更換 FAS9000 系統中的 DIMM 以修復記憶體容量錯誤
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當 FAS9000 系統透過健康監視器警報報告過多可修正的 ECC 記憶體容量錯誤或不可修正的 ECC 錯誤時，請更換系統中的 DIMM 記憶體條。故障的 DIMM 記憶體條可能導致儲存系統無法開機 ONTAP，因此更換它可以恢復系統的穩定運作。
