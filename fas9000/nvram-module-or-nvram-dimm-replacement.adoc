...
summary: 在 FAS9000 系統中，更換故障的 NVRAM 模組或 NVRAM 模組內的 DIMM 記憶體條。由於系統 ID 源自 NVRAM 模組，因此更換模組會將屬於該系統的磁碟重新指派給新的系統 ID。 
---
= 更換 FAS9000 系統中的 NVRAM 模組或 NVRAM DIMM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 FAS9000 系統中，更換故障的 NVRAM 模組或 NVRAM 模組內的 DIMM 記憶體條。由於系統 ID 源自 NVRAM 模組，因此更換模組會將屬於該系統的磁碟重新指派給新的系統 ID。
