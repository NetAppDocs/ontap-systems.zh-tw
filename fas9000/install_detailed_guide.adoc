...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=7a55b98a-e8b8-41d5-821f-ac5b0032ead0["連接雙節點無交換器叢集"]



image::../media/drw_9000_TNSC_composite_cabling.png[DRw 9000 TSC複合纜線]

. 前往 <<Step 4: Cable controllers to drive shelves>> 以取得磁碟機櫃佈線指示。
...
. 請使用動畫或圖例來完成控制器與交換器之間的佈線：
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=6381b3f1-4ce5-4805-bd0a-ac5b0032f51d["交換式叢集纜線"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=a312e09e-df56-47b3-9b5e-ab2300477f67["SAS儲存設備的佈線ONTAP ：Sing 9.7及更早版本"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=61d23302-9526-4a2b-9335-ac5b0032eafd["SAS儲存設備佈線：ONTAP Sing 9.8及更新版本"]
...
+
link:..https://docs.netapp.com/us-en/ontap-systems/sas3/install-new-system.html["安裝及纜線架以安裝新的系統-機櫃內有IOM12模組"]

+
image:../media/Cable_shelves_new_system_IOM12_shelves.png[""]

. 前往 <<Step 5: Complete system setup and configuration>> 以完成系統設定與組態。
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=6520eb01-87b3-4520-9109-ac5b0032ea4e["單一NS224機櫃的纜線連接- ONTAP S9.8及更新版本"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=34098e39-73ad-45de-9af7-ac5b0032ea9a["連接兩個NS224磁碟櫃- ONTAP S9.8及更新版本"]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=95a29da1-faa3-4ceb-8a0b-ac7600675aa6["設定SAS或NVMe磁碟機磁碟櫃ID"]

. 將電源線插入控制器電源供應器、然後將電源線連接至不同電路上的電源。
. 開啟兩個節點的電源開關。
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=bb04eb23-aa0c-4821-a87d-ab2300477f8b["開啟控制器的電源"]
