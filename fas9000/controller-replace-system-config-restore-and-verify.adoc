...
summary: 在 FAS9000 系統中完成控制器硬體更換並開機至維護模式後，請驗證更換控制器的低階系統組態，並視需要重新設定系統設定。 
---
= 恢復並驗證 FAS9000 系統中的控制器組態
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 FAS9000 系統中完成控制器硬體更換並開機至維護模式後，請驗證更換控制器的低階系統組態，並視需要重新設定系統設定。
