...
summary: 更換 FAS9000 系統中的開機媒體，方法是移除受損的控制器模組、安裝替換開機媒體，並將開機映像傳輸到 USB 快閃磁碟機。 
---
= 更換 FAS9000 系統中的開機媒體
:allow-uri-read: 
:icons: font
...
[role="lead"]
若要更換 FAS9000 系統中的開機媒體，請移除受損的控制器模組、安裝替換的開機媒體，並將開機映像傳輸至 USB 快閃磁碟機。FAS9000 系統僅支援手動開機媒體恢復；不支援自動開機媒體恢復。
