...
summary: 重新連接儲存設備，並確認 FAS9000 系統上的磁碟重新分配，以便更換後的控制器能夠恢復正常運作。 
---
= 將 FAS9000 系統中的控制器交還，以恢復正常運作。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
重新連接儲存設備，並確認 FAS9000 系統上的磁碟重新分配，以便更換後的控制器能夠恢復正常運作。
...
--
.選項 2：雙節點MetroCluster
--
=== 在雙節點MetroCluster配置中的系統上手動重新分配系統 ID
