...
summary: 從已完全配置的 FAS9000 系統中移除一個或多個現有的 NIC 或儲存設備模組，以便安裝一個或多個 X91148A 儲存設備模組。 
---
= 當 FAS9000 系統所有插槽均已佔用時，新增 X91148A 儲存設備模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
從已完全配置的 FAS9000 系統中移除一個或多個現有的 NIC 或儲存設備模組，以便安裝一個或多個 X91148A 儲存設備模組。
