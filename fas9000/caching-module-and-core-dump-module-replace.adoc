...
summary: 當 FAS9000 系統收到單一 AutoSupport（ASUP）訊息，表示快取模組或核心傾印模組已離線時，應更換此模組。否則，會導致效能減低。 
---
= 更換 FAS9000 系統中的快取模組或核心傾印模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當 FAS9000 系統收到單一 AutoSupport（ASUP）訊息，表示快取模組或核心傾印模組已離線時，應更換此模組。否則，會導致效能減低。
