...
---
= 在沒有開放式插槽AFF 的系統中新增X91148A儲存模組-例如：NetApp產品系列的
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. 如果停用自動恢復功能、請啟用：「儲存容錯移轉修改節點本機-自動恢復true」
. 對控制器B重複這些步驟
. 如所述、安裝並連接NS224磁碟櫃 https://docs.netapp.com/platstor/topic/com.netapp.doc.hw-ds-nvme-hotadd/GUID-B215753F-F3E6-4FA0-A1E1-B9390B19AD94.html["熱新增NS224磁碟機櫃"]。
