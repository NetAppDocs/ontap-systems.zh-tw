...
summary: 若要完成更換程序並使系統恢復到完全運作狀態，您必須重新連接儲存設備、視需要還原 NetApp Storage Encryption 組態，並為新控制器安裝授權。 
---
= 完整系統還原： FAS9000
:allow-uri-read: 
:icons: font
...
== 步驟3：MetroCluster （僅供參考）：在雙節點MetroCluster 的「僅供參考」組態中切換回集合體
