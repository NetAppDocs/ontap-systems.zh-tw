...
summary: 在不中斷服務的情況下更換 FAS9000 系統中的 LED USB 模組。此模組提供與主控台連接埠的連線及系統狀態資訊，更換時無需任何工具。 
---
= 在 FAS9000 系統中熱插拔 LED USB 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在不中斷服務的情況下更換 FAS9000 系統中的 LED USB 模組。此模組提供與主控台連接埠的連線及系統狀態資訊，更換時無需任何工具。
