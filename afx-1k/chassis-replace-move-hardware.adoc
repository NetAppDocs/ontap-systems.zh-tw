...
summary: 當硬體故障需要更換時，請更換 AFF A1K 儲存系統的機箱。更換過程包括從機箱前面移除控制器、移除電源供應器、NVRAM12、I/O 模組和擋板以及系統管理模組，然後安裝替換機箱，並重新安裝機箱元件。 
---
= 更換底盤 - AFX 1K
:allow-uri-read: 
:icons: font
...
.接下來呢？
更換損壞的 AFX 1K 機殼並重新安裝其元件後，請完成link:chassis-replace-complete-system-restore-rma.html["底盤更換"]。
