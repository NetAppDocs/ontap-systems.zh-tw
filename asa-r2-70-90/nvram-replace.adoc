...
---
= 更換 ASA A70 或 ASA A90 系統中的 NVRAM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當非揮發性記憶體故障或需要升級時，請更換ASA A70 或ASA A90 系統中的NVRAM 。更換過程包括關閉受損的控制器、將控制器拉出幾英寸以完全切斷電源、更換NVRAM模組或NVRAM DIMM、重新分配磁碟，以及將故障部件返回給NetApp。
