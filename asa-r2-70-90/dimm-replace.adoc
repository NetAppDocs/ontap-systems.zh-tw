...
summary: 當偵測到過度可修正或不可修正的錯誤時，請更換 AFF C80 系統中的 DIMM 。這些問題通常是由單一 DIMM 故障所造成，可能會導致儲存系統無法開機 ONTAP 。 
---
...
[role="lead"]
當偵測到過度可修正或不可修正的錯誤時，請更換 AFF C80 系統中的 DIMM 。這些問題通常是由單一 DIMM 故障所造成，可能會導致儲存系統無法開機 ONTAP 。
