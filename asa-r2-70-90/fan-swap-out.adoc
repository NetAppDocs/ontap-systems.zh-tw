...
summary: 當風扇故障或無法有效運作時，請更換 ASA A70 或 ASA A90 系統中的風扇模組，因為這可能會影響系統冷卻和整體效能。更換程序包括關閉控制器，移除控制器，更換風扇，重新安裝控制器，以及將故障零件退回 NetApp 。 
---
= 更換 ASA A70 或 ASA A90 系統中的風扇模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當風扇故障或無法有效運作時，請更換 ASA A70 或 ASA A90 系統中的風扇模組，因為這可能會影響系統冷卻和整體效能。更換程序包括關閉控制器，移除控制器，更換風扇，重新安裝控制器，以及將故障零件退回 NetApp 。
