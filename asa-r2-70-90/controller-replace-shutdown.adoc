...
summary: 當控制器受損時，請關閉 ASA A70 或 ASA A90 儲存系統中的控制器。在執行維護或元件更換之前，請務必安全關閉控制器，以避免資料遺失並確保系統穩定性。 
---
= 關閉受損控制器 - ASA A70 和 ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當控制器受損時，請關閉 ASA A70 或 ASA A90 儲存系統中的控制器。在執行維護或元件更換之前，請務必安全關閉控制器，以避免資料遺失並確保系統穩定性。
