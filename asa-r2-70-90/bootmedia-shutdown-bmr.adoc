...
summary: 關閉 ASA A70 或 ASA A90 儲存系統中受損的控制器，以防止資料遺失，並確保更換開機媒體時系統穩定性。 
---
= 在自動開機恢復過程中，關閉 ASA A70 或 ASA A90 系統中的控制器。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉 ASA A70 或 ASA A90 儲存系統中受損的控制器，以防止資料遺失，並確保更換開機媒體時系統穩定性。
