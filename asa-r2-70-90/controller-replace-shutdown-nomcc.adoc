...
summary: 關閉 ASA A70 或 ASA A90 儲存系統中的控制器，以防止資料遺失，並確保更換控制器時系統穩定。 
---
= 在非 MetroCluster 組態下，關閉 ASA A70 或 ASA A90 系統中發生故障的控制器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉 ASA A70 或 ASA A90 儲存系統中的控制器，以防止資料遺失，並確保更換控制器時系統穩定。
