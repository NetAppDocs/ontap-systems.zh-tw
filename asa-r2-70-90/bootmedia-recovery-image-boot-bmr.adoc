...
summary: 如果 ASA A70 或 ASA A90 系統中的開機媒體毀損，您可以開機恢復映像，從合作夥伴節點還原組態，以及驗證環境變數。 
---
= 還原 ONTAP 映像 - ASA A70 和 ASA A90
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果 ASA A70 或 ASA A90 系統中的開機媒體毀損，您可以從合作夥伴節點開機恢復映像並還原組態。
