...
summary: 當您的 ASA A70 或 ASA A90 系統中的交流或直流電源單元發生故障或損壞時，請更換此電源單元，以確保系統持續獲得穩定運作所需的電力。更換過程包括：斷開故障電源單元與電源的連接、拔除電源線、更換故障電源單元，然後重新連接電源。 
---
= 在 ASA A70 或 ASA A90 系統中熱交換的電源供應單元
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
