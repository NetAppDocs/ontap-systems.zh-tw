...
summary: 當或 ASA A90 系統故障或故障時，請更換 ASA A70 或 DC 電源供應器（ PSU ），以確保您的系統能繼續接收所需的電力，以確保運作穩定。更換程序包括中斷目標 PSU 與電源的連接，拔下電源線，移除故障 PSU ，安裝更換 PSU ，然後將其重新連接至電源。 
---
...
[role="lead"]
當或 ASA A90 系統故障或故障時，請更換 ASA A70 或 DC 電源供應器（ PSU ），以確保您的系統能繼續接收所需的電力，以確保運作穩定。更換程序包括中斷目標 PSU 與電源的連接，拔下電源線，移除故障 PSU ，安裝更換 PSU ，然後將其重新連接至電源。
