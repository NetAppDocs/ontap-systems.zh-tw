...
summary: 關閉 ASA A70 或 ASA A90 儲存系統中的控制器，以防止資料遺失，並確保更換機箱時系統穩定。 
---
= 更換機箱時，請關閉 ASA A70 或 ASA A90 控制器。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
關閉 ASA A70 或 ASA A90 儲存系統中的控制器，以防止資料遺失，並確保更換機箱時系統穩定。
...
.接下來呢？
控制器關機後，您需要link:chassis-replace-move-hardware.html["更換機箱"]執行。
