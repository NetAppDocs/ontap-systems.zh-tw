...
summary: 如果 ASA A70 或 ASA A90 儲存系統中的某個乙太網路 I/O 模組發生故障，並且您的儲存系統符合所有 ONTAP 版本要求，則可以熱插拔該模組。 
---
= 在不關機的情況下，熱交換 ASA A70 或 ASA A90 系統中的 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果 ASA A70 或 ASA A90 儲存系統中的某個乙太網路 I/O 模組發生故障，並且您的儲存系統符合所有 ONTAP 版本要求，則可以熱插拔該模組。
