...
summary: 依照套件隨附的 RMA 說明，還原 NetApp Storage Encryption 或 Volume Encryption 組態（如有必要）、安裝替換控制器的授權，並將故障零件退回 NetApp，即可使 FAS2820 系統恢復完全運作。 
---
= 完成 FAS2820 系統的控制器更換工作
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
依照套件隨附的 RMA 說明，還原 NetApp Storage Encryption 或 Volume Encryption 組態（如有必要）、安裝替換控制器的授權，並將故障零件退回 NetApp，即可使 FAS2820 系統恢復完全運作。
