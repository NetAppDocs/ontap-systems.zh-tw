...
summary: 若要完成控制器更換並將 FAS2820 系統還原為完全運作狀態，您必須重新連接儲存設備、確認磁碟重新分配、還原 NetApp 儲存加密組態（如有必要），並為新控制器安裝授權。 
---
= 將 FAS2820 系統中的控制器交還，以恢復正常運作。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
若要完成更換程序並將 FAS2820 系統還原為完全運作狀態，您必須重新連接儲存設備、確認磁碟重新分配、還原 NetApp 儲存加密組態（如有必要），並為新控制器安裝授權。
