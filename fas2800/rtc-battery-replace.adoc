...
summary: 您需要更換 FAS2820 系統控制器模組中的即時時鐘電池，以便依賴精確時間同步的服務和應用程式能夠繼續運作。 
---
= 更換 FAS2820 系統中的即時時鐘電池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您需要更換 FAS2820 系統控制器模組中的即時時鐘 （RTC） 電池，以便依賴精確時間同步的服務和應用程式能夠繼續運作。
...
找到控制器內部的 RTC 電池，然後依照特定步驟順序更換電池。
