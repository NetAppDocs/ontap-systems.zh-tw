...
summary: 當您的 FAS2820 系統控制器模組中的快取模組登錄單一 AutoSupport 訊息，指出該模組已離線時，您必須更換該快取模組。如果不更換故障模組，您的儲存系統將會發生效能減低的情況。 
---
= 更換 FAS2820 系統中的快取模組
:allow-uri-read: 
:icons: font
...
[role="lead"]
當您的 FAS2820 系統控制器模組收到單一 AutoSupport （ASUP）訊息，表示快取模組已離線時，您必須更換該快取模組。如果不更換故障模組，您的儲存系統將會效能減低。
