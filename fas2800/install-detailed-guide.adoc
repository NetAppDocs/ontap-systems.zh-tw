...
+
image::../media/oie_cable_mini_sas_hd_to_mini_sas_hd.svg[Mini SAS 至 Mini SAS 連接器]
...
+ 影像： ../media/drw_2800_Shelf 至 Shelf 纜線 _IEOS-895.svg [ 機架至機櫃纜線 ]

+ 。將控制器 A 纜線連接至磁碟機櫃。...控制器 A 連接埠 0A 至堆疊中第一個磁碟機櫃上的 IOM B 連接埠 1 。...控制器 A 連接埠 0b1 至 IOM A 連接埠 3 、位於堆疊中最後一個磁碟機櫃上。

+ 影像： ../media/oie_cable ， mini ， sas ， hd ， to ， mini ， sas ， hd ， svg [ Mini SAS 到 Mini SAS 連接器 ]

* Mini-SAS HD 至 Mini-SAS HD 纜線 *

+ 影像： ../media/DWR-2800_controller1-sender_IEOS-896.svg [ 控制器 A 至機櫃連線 ]

+ 。將控制器 B 連接至磁碟機櫃。...控制器 B 連接埠 0A 至堆疊中第一個磁碟機櫃上的 IOM A 連接埠 1 。...控制器 B 連接埠 0b1 至堆疊中最後一個磁碟機櫃上的 IOM B 連接埠 3 。

+ 影像： ../media/oie_cable ， mini ， sas ， hd ， to ， mini ， sas ， hd ， svg [ Mini SAS 到 Mini SAS 連接器 ]

* Mini-SAS HD 至 Mini-SAS HD 纜線 *

+ 影像： ../media/DWR-2800_controller2-senders_IEOS-897.svg [ 控制器 B 至機櫃連線 ]
