...
summary: 更換啟動媒體時，請關閉 AFX 2K 儲存系統中發生故障的控制器，以防止資料遺失並確保系統穩定性。 
---
= 在自動開機恢復過程中，關閉 AFX 2K 儲存系統中的控制器。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更換啟動媒體時，請關閉 AFX 2K 儲存系統中發生故障的控制器，以防止資料遺失並確保系統穩定性。
...
.接下來呢？
關閉控制器後，link:bootmedia-replace.html["更改啟動媒體"] 。
