...
summary: 在 AFF A2K 儲存系統中安裝新的開機媒體裝置後，您可以啟動自動開機媒體還原程序，以從合作夥伴節點還原組態。 
---
= 使用自動開機恢復流程，在 AFX 2K 儲存系統上啟動恢復映像。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 AFF A2K 儲存系統中安裝新的開機媒體裝置後，您可以啟動自動開機媒體還原程序，以從合作夥伴節點還原組態。
...
+
該過程嘗試從夥伴節點恢復適當的檔案並重新啟動該節點。繼續進行下一步。
