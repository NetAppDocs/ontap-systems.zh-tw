...
summary: 當您的 AFX 2K 儲存系統中的 NV 電池開始漏電或故障時，請更換該電池，因為它負責在斷電期間保存關鍵系統資料。更換程序包括：關閉故障控制器，拆下控制器模組，更換 NV 電池，重新安裝控制器模組，然後將故障零件退回 NetApp。 
---
= 更換 AFX 2K 儲存系統中的 NV 電池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當您的 AFX 2K 儲存系統中的 NV 電池開始漏電或故障時，請更換該電池，因為它負責在斷電期間保存關鍵系統資料。更換程序包括：關閉故障控制器，拆下控制器模組，更換 NV 電池，重新安裝控制器模組，然後將故障零件退回 NetApp。

.關於這項工作
此步驟適用於更換 AFX 2K 控制器插槽 4 和 5 中 NVRAM 模組的故障 NV 電池。有關如何更換 AFX 2K 控制器插槽 6 和 7 中 NVRAM12-EX 模組的 NV 電池的資訊，請參閱 link:nv12l-replace.html#step-2-replace-the-nvram12-ex-module-nvram-dimm-or-nvram-battery["更換 NVRAM12-EX 的 NV 電池"]。
