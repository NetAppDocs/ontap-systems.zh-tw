...
summary: 若要更換 AFX 2K 儲存系統中損壞的機箱，請先識別損壞的機箱，驗證更換的組件，並標記纜線和控制器模組。 
---
= 準備更換機殼 - AFX 2K
:allow-uri-read: 
:icons: font
...
[role="lead"]
若要更換 AFX 2K 儲存系統中損壞的機箱，請先識別損壞的機箱，驗證更換的組件，並標記纜線和控制器模組。
...
.接下來呢？
準備好更換 AFX 2K 機殼硬體後，您需要link:chassis-replace-shutdown.html["關閉控制器"]。
