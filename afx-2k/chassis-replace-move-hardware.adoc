...
summary: 當您的 AFX 2K 儲存系統出現硬體故障需要更換機殼時，請進行更換。更換過程包括：從機殼前面板拆下控制器、電源供應器、NVRAM12、I/O 模組和擋板、系統管理模組，然後安裝替換機殼，最後重新安裝機殼組件。 
---
= 更換 AFX 2K 系統中的機箱
:allow-uri-read: 
:icons: font
...
[role="lead"]
當您的 AFX 2K 儲存系統出現硬體故障需要更換機殼時，請進行更換。更換過程包括：拆卸控制器、I/O 卡、NVRAM12 模組、系統管理模組和電源供應器 （PSU），安裝新的機殼，然後重新安裝機殼組件。
...
+
image::../media/drw_afx_2k_psu_remove_replace_ieops-2882.svg[移除或更換 PSU]
...
== 步驟 2：移除 I/O 卡、NVRAM12、NVRAM12-EX 和系統管理模組

. 從機箱中移除目標I/O模組：
+
image:../media/drw_afx_2k_io_remove_replace_ieops-2878.svg["移除 I/O 模組"]
...
+
image::../media/drw_nvram1_remove_only_ieops-2574.svg[移除 NVRAM12 模組]
...
+
.. 抓住模組上的把手，按下鎖定凸輪按鈕。
.. 用一隻手托住模組底部，另一隻手將 NVRAM12-EX 模組從機殼中拔出。
+
...
+
image::../media/drw_afx_2k_sys_mgmt_remove_replace_ieops-2880.svg[系統管理刪除]
...
.接下來呢？
更換損壞的 AFX 2K 機殼並重新安裝其元件後，請完成link:chassis-replace-complete-system-restore-rma.html["底盤更換"]。
