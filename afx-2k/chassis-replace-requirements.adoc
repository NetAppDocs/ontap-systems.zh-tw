...
summary: 在更換 AFX 2K 儲存系統中的機殼之前，請確保滿足成功更換所需的所有條件。這包括驗證系統中的所有其他元件是否正常運作，確認您擁有 ONTAP 的本機管理員憑證，以及擁有正確的替換機殼和必要的工具。 
---
= 更換 AFX 2K 機箱前，請先查看相關要求。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更換 AFX 2K 儲存系統中的機殼之前，請確保滿足成功更換所需的所有條件。這包括驗證系統中的所有其他元件是否正常運作，確認您擁有 ONTAP 的本機管理員憑證，以及擁有正確的替換機殼和必要的工具。
