...
summary: 當您的 AFX 2K 儲存系統中的系統管理模組故障或韌體損壞時，請更換模組。更換過程包括：關閉控制器、更換故障的系統管理模組、重新啟動控制器、更新授權金鑰，然後將故障零件退回 NetApp。 
---
= 更換 AFX 2K 儲存系統中的系統管理模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當您的 AFX 2K 儲存系統中的系統管理模組故障或韌體損壞時，請更換模組。更換過程包括：關閉控制器、更換故障的系統管理模組、重新啟動控制器、更新授權金鑰，然後將故障零件退回 NetApp。

系統管理模組位於控制器背面插槽 8 左側，包含用於系統管理的內建元件以及用於外部管理的連接埠。若要更換損壞的系統管理模組或開機媒體，必須關閉目標控制器並斷電。
