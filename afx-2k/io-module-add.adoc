...
summary: 在 AFX 2K 儲存系統中新增 I/O 模組，以增強網路連線能力並擴展系統處理資料流量的能力。 
---
= 在 AFX 2K 系統中新增 I/O 模組以增強網路連線能力
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 AFX 2K 儲存系統中新增 I/O 模組，以增強網路連線能力並擴展系統處理資料流量的能力。

當 AFX 2K 儲存系統有空插槽可用或所有插槽均已佔滿時，您可以為其新增 I/O 模組。
...
.開始之前
* 檢查 https://hwu.netapp.com["NetApp Hardware Universe"^]以確保新的 I/O 模組與您的儲存系統和 ONTAP 版本相容。
