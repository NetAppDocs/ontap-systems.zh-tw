...
summary: 如果 AFX 2K 儲存系統中的某個乙太網路 I/O 模組發生故障，而您的儲存系統符合所有 ONTAP 版本要求，則可以熱插拔該模組。 
---
= 在 AFX 2K 儲存系統中熱插拔 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果 AFX 2K 儲存系統中的某個乙太網路 I/O 模組發生故障，而您的儲存系統符合所有 ONTAP 版本要求，則可以熱插拔該模組。
