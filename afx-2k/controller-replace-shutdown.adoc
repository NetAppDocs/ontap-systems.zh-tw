...
summary: 當您的 AFX 2K 儲存系統中的控制器發生故障時，請將其關閉。在進行維護或更換組件之前，安全地關閉控制器至關重要，以防止資料遺失並確保系統穩定性。 
---
= 更換 AFX 2K 儲存系統中發生故障的控制器之前，請先將其關閉。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更換控制器時，請關閉 AFX 2K 儲存系統中發生故障的控制器，以防止資料遺失並確保系統穩定性。
