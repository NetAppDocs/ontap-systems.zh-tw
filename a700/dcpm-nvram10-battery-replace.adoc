...
summary: 若要熱插拔包含 NVRAM10 電池的降級控制器電源模組，請找出故障的 DCPM 模組、將其從機箱中取出，然後安裝替換的 DCPM 模組。 
---
= 在您的 AFF A700 系統中熱插拔降級控制器電源模組 (DCPM)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 AFF A700 系統中熱插拔降級控制器電源模組 (DCPM)，以更換故障模組，而無需中斷服務。
