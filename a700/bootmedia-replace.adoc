...
summary: 更換AFF A700控制器模組上故障的啟動介質。AFF A700系統僅支援手動啟動媒體復原程式。不支援自動啟動媒體恢復。 
---
= 更換 AFF A700 系統中的開機媒體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更換AFF A700控制器模組上故障的啟動介質。此過程包括從機箱中取出控制器模組，物理更換啟動介質組件，使用 USB 隨身碟將啟動映像傳輸到更換的介質，以及將系統恢復到正常運作狀態。
