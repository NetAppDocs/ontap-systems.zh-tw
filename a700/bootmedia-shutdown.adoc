...
summary: 在手動開機媒體恢復過程中，關閉 AFF A700 儲存系統中的控制器，以防止資料遺失並維持系統穩定性。 
---
= 在手動開機恢復過程中，關閉 AFF A700 系統中的控制器。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在手動開機媒體恢復過程中，關閉 AFF A700 儲存系統中的控制器，以防止資料遺失並維持系統穩定性。
...
完成 NVE 或 NSE 任務後，您需要完成節點的關閉。注意：如果您的系統採用雙節點 MetroCluster 組態，請勿使用此步驟。
