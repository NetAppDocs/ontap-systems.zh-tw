...
summary: 若要開始更換 AFF A250 儲存系統中的開機媒體，請先檢閱更換需求、關閉控制器、更換開機媒體、還原開機媒體上的映像，並驗證系統功能。 
---
= 使用自動化開機恢復流程的 AFF A250 開機媒體更換工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
開機映像的自動恢復包括系統自動辨識並選擇對應的開機功能表選項。它使用合作夥伴節點上的開機映像，將 ONTAP 重新安裝到 AFF A250 儲存系統中的替換開機媒體上。
