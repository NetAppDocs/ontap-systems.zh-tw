...
.步驟
. 使用動畫（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=beec3966-0a01-473c-a5de-ac68017fbf29["連接雙節點無交換器叢集"^]）或完成控制器與交換器之間佈線的逐步指示：
+
[cols="10,90"]
|===
| 步驟 | 在每個控制器上執行 
...
image:../media/oie_legend_icon_1_lg.png[""]
 a| 
使用25GbE叢集互連纜線將叢集互連連接埠彼此連接image:../media/oie_cable_sfp_gbe_copper.png[""]：
...
.步驟
. 使用動畫（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=bf6759dc-4cbf-488e-982e-ac68017fbef8["交換式叢集的佈線"^]）或完成控制器與交換器之間佈線的逐步指示：
+
[cols="10,90"]
|===
| 步驟 | 在每個控制器上執行 
...
1.
 a| 
將連接埠2a至2D連接至FC主機交換器。image:../media/drw_affa250_fc_host_cabling.png[""]
...
1.
 a| 
將E4A至e4d纜線連接埠連接至10GbE主機網路交換器。image:../media/drw_affa250_25gbe_host_cabling.png[""]
...
. 使用動畫（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=3f92e625-a19c-4d10-9028-ac68017fbf57["將控制器佈線至單一NS224"^]）或將控制器模組纜線連接至單一機櫃的逐步指示。
+
[cols="10,90"]
|===
| 步驟 | 在每個控制器模組上執行 
...
. 使用動畫（link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=d61f983e-f911-4b76-8b3a-ab1b0066909b["將筆記型電腦連接至管理交換器"^]）將筆記型電腦連接至管理交換器。
. 選取ONTAP 列出的功能表圖示以探索：
+
