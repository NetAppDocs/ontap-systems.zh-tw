...
summary: AFF A250 系統中的開機媒體儲存重要的韌體和組態資料。更換程序包括移除控制器模組、移除受損的開機媒體、在控制器模組中安裝替換的開機媒體、然後重新安裝控制器模組。 
---
= 使用自動開機恢復流程更換 AFF A250 系統中的開機媒體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A250 系統中的開機媒體儲存重要的韌體和組態資料。更換程序包括移除並開啟控制器模組、移除受損的開機媒體、在控制器模組中安裝替換的開機媒體、然後重新安裝控制器模組。
