...
summary: 若要更換 AFF A250 系統中的電源供應器，請中斷目標 PSU 與電源的連線、拔下電源線、移除舊的 PSU、安裝替換的 PSU，然後將其重新連接至電源。 
---
= 在 AFF A250 系統中熱插拔電源供應單元
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當您的 AFF A250 系統電源故障或損壞時，請更換電源供應。電源供應採用備援且熱交換的設計，因此您無需關閉控制器即可進行更換。
