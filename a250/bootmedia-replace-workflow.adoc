...
summary: 若要開始更換 AFF A250 儲存系統中的開機媒體，請先檢閱更換需求、檢查加密狀態、關閉控制器、更換開機媒體、開機復原映像、還原加密，並驗證系統功能。 
---
= 使用手冊開機恢復流程的 AFF A250 開機媒體更換工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
若要開始更換 AFF A250 儲存系統中的開機媒體，請先檢閱更換需求、檢查加密狀態、關閉控制器、更換開機媒體、開機復原映像、還原加密，並驗證系統功能。
