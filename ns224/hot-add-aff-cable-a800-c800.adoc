...
summary: 將 NS224 機架透過電纜連接到 AFF A800 或 AFF C800 系統，以便每個機架與 HA 配對中的每個控制器都有兩個連接。 
---
= 將 NS224 機架連接到您的 AFF A800 或 AFF C800 系統
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將 NS224 機架透過電纜連接到 AFF A800 或 AFF C800 系統，以便每個機架與 HA 配對中的每個控制器都有兩個連接。
