...
summary: 將 NS224 機架連接到 AFF A400 或 AFF C400 系統，使每個機架與 HA 配對中的每個控制器都有兩個連線。 
---
= 將 NS224 機架連接到您的 AFF A400 或 AFF C400 系統
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將 NS224 機架連接到 AFF A400 或 AFF C400 系統，使每個機架與 HA 配對中的每個控制器都有兩個連線。
