...
summary: 將 NS224 機架連接到 ASA A70 或 ASA A90 系統，使每個機架與 HA 配對中的每個控制器都有兩個連接。 
---
= 將 NS224 機架連接到您的 ASA A70 或 ASA A90 系統
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將 NS224 機架連接到 ASA A70 或 ASA A90 系統，使每個機架與 HA 配對中的每個控制器都有兩個連接。
