...
[%collapsible]
====
您可以將最多三個額外的 NS224 機櫃（總共四個機櫃）熱新增至 ASA A1K HA 配對。
...
+
image::../media/drw_ns224_vino_m_2shelves_2cards_ieops-1642.svg[ASA A1K 纜線、含兩個機櫃和兩個 IO 模組]
...
+
image::../media/drw_ns224_vino_m_3shelves_3cards_ieops-1643.svg[ASA A1K 纜線、含三個機櫃和三個 IO 模組]
...
+
image::../media/drw_ns224_vino_m_3shelves_4cards_ieops-1644.svg[ASA A1K 纜線、含三個機櫃和四個 IO 模組]
...
+
image::../media/drw_ns224_vino_m_4shelves_4cards_ieops-1645.svg[ASA A1K 纜線、含四個機櫃和四個 IO 模組]
...
====
.連接至 ASA A70 或 ASA A90 的纜線架
[%collapsible]
====
當需要額外儲存（至內部機櫃）時、您最多可以將兩個 NS224 機櫃熱新增至 ASA A70 或 ASA A90 HA 配對。
...
+
image::../media/drw_ns224_vino_i_1shelf_1card_ieops-1639.svg[ASA A70 或 A90 的纜線、含一個機櫃和一個 IO 模組]
...
image::../media/drw_ns224_vino_i_1shelf_2cards_ieops-1640.svg[ASA A70 或 A90 的纜線、含一個機櫃和兩個 IO 模組]
...
image::../media/drw_ns224_vino_i_2shelves_2cards_ieops-1641.svg[ASA A70 或 A90 的纜線、含兩個機櫃和兩個 IO 模組]
