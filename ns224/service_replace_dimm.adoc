...
+
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=eef28b10-ed93-4aa7-bfce-aa86002f20a2["更換NS224磁碟機櫃中的DIMM"^]
...
. 實體識別故障的DIMM。
+
當DIMM故障時、系統會將警告訊息記錄到系統主控台、指出哪個DIMM故障。此外、位於DIMM插槽旁的主機板上的DIMM警示（黃色）LED會亮起。

+

NOTE: 從機櫃中取出NSM模組後、故障DIMM的LED會持續亮起10分鐘。
