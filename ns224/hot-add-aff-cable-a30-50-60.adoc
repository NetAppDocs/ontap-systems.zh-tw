...
summary: 將 NS224 機架連接到 AFF A30、AFF A50、AFF C30 或 AFF C60 系統，以便每個機架與 HA 配對中的每個控制器都有兩個連線。 
---
= 將 NS224 機架透過電纜連接到您的 AFF A30、AFF A50、AFF C30 或 AFF C60 系統
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將 NS224 機架連接到 AFF A30、AFF A50、AFF C30 或 AFF C60 系統，以便每個機架與 HA 配對中的每個控制器都有兩個連線。
