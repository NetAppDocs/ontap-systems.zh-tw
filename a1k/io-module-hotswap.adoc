...
summary: 如果 AFF A1K 儲存系統中的乙太網路 I/O 模組發生故障，您可以熱插拔該模組，前提是您的儲存系統符合所有 ONTAP 版本要求。 
---
= 在不關機的情況下，熱交換 AFF A1K 系統中的 I/O 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
如果 AFF A1K 儲存系統中的乙太網路 I/O 模組發生故障，您可以熱插拔該模組，前提是您的儲存系統符合所有 ONTAP 版本要求。

若要熱交換 I/O 模組，請確認您的儲存系統運作的是 ONTAP 9.18.1 GA 或更新版本。然後準備儲存系統和 I/O 模組，熱交換故障模組，將替換模組上線，還原正常運作，並將故障模組退回 NetApp。
