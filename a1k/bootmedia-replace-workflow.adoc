...
summary: 開始更換 AFF A1K 儲存系統中的開機媒體，方法是檢閱更換需求，檢查加密狀態，關閉控制器，更換開機媒體，開機恢復映像，還原加密，以及驗證系統功能。 
---
= 開機媒體更換工作流程 - AFF A1K
:allow-uri-read: 
:icons: font
...
[role="lead"]
開始更換 AFF A1K 儲存系統中的開機媒體，方法是檢閱更換需求，檢查加密狀態，關閉控制器，更換開機媒體，開機恢復映像，還原加密，以及驗證系統功能。
