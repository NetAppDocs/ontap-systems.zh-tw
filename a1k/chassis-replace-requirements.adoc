...
summary: 在更換 AFF A1K 系統中的機箱之前，請確認您符合成功更換所需的所有條件。這包括確認系統中的所有其他元件均運作正常、確認您擁有 ONTAP 的本機系統管理員憑證、確認您擁有正確的替換機箱以及必要的工具。 
---
= 更換 AFF A1K 機箱前，請先查看相關要求。
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在更換 AFF A1K 系統中的機箱之前，請確認您符合成功更換所需的所有條件。這包括確認系統中的所有其他元件均運作正常、確認您擁有 ONTAP 的本機系統管理員憑證、確認您擁有正確的替換機箱以及必要的工具。
