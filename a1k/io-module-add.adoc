...
summary: 將 I/O 模組新增至 AFF A1K 系統，以增強網路連線能力，並擴充系統處理資料流量的能力。 
---
= 在 AFF A1K 系統中新增 I/O 模組以增強網路連線能力
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將 I/O 模組新增至 AFF A1K 系統，以增強網路連線能力，並擴充系統處理資料流量的能力。

當有可用的空插槽或所有插槽已完全填入時，您可以將 I/O 模組新增至 AFF A1K 儲存系統。
