...
summary: 當您的 AFF A1K 系統中的系統管理模組故障或韌體損壞時，請更換此系統管理模組。更換過程包括：關閉控制器、更換故障的系統管理模組、重新開機控制器、更新授權金鑰，並將故障零件退回 NetApp。 
---
= 更換 AFF A1K 系統中的 System Management 模組
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當您的 AFF A1K 系統中的系統管理模組故障或韌體損壞時，請更換模組。更換過程包括：關閉控制器、更換故障的系統管理模組、重新啟動控制器、更新授權金鑰，並將故障零件退回 NetApp。
