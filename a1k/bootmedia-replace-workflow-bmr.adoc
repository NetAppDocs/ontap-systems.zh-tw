...
summary: 啟動映像的自動恢復涉及系統自動識別並選擇適當的啟動選單選項。它使用合作夥伴節點上的啟動映像在AFF A1K系統中的替換啟動媒體上重新安裝ONTAP 。 
---
...
[role="lead"]
啟動映像的自動恢復涉及系統自動識別並選擇適當的啟動選單選項。它使用合作夥伴節點上的啟動映像在AFF A1K 儲存系統中的替換啟動媒體上重新安裝ONTAP 。
