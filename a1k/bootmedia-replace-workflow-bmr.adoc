...
summary: 開機映像的自動恢復包括系統自動辨識並選擇對應的開機功能表選項。它使用合作夥伴節點上的開機映像，將 ONTAP 重新安裝到 AFF A1K 系統中的替換開機媒體上。 
---
= 使用自動化開機恢復流程的 AFF A1K 開機媒體更換工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
開機映像的自動恢復包括系統自動辨識並選擇對應的開機功能表選項。它使用合作夥伴節點上的開機映像，將 ONTAP 重新安裝到 AFF A1K 儲存系統中的替換開機媒體上。
