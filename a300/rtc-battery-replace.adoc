...
summary: 更換 AFF A300 控制器模組中的即時時鐘電池，以確保依賴精確時間同步的服務和應用程式能夠繼續運作。 
---
= 更換 AFF A300 系統中的即時時鐘電池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更換 AFF A300 系統中的即時時鐘 （RTC） 電池，以確保依賴精確時間同步的服務和應用程式能夠繼續運作。
...
. 找到RTC電池。
+
image::../media/drw_rxl_rtc_battery.png[取出或更換 RTC 電池]
