...
summary: 在已替換的開機媒體上還原加密。完成針對已啟用 Onboard Key Manager、NetApp Storage Encryption 或 NetApp Volume Encryption 的系統的特定步驟。AFF A300 系統僅支援手動開機媒體還原程序。 
---
= 在 AFF A300 系統中恢復開機媒體上的加密
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
恢復替換啟動媒體上的加密。AFF A300系統僅支援手動啟動媒體復原程式。不支援自動啟動媒體恢復。
