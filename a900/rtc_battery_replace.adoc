...
summary: 您需要更換控制器模組中的即時時鐘電池，以確保系統中依賴精確時間同步的服務和應用程式能夠繼續運作。 
---
= 更換 AFF A900 系統中的即時時鐘電池
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
更換 AFF A900 系統中的即時時鐘 （RTC） 電池，以確保依賴精確時間同步的服務和應用程式能夠繼續運作。
...
+
image::../media/drw_a900_remove_RTC_battery.svg[取出並安裝 RTC 電池]
