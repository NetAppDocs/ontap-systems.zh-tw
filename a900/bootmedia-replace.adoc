...
---
= 使用手動開機恢復流程更換 AFF A900 系統中的開機媒體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFF A900 系統中的開機媒體儲存著重要的韌體和組態資料。更換過程包括：移除控制器模組、移除受損的開機媒體、安裝替換的開機媒體，然後使用 USB 快閃磁碟機將 ONTAP 映像傳輸到替換的開機媒體。
...
+
image::../media/drw_a900_remove_boot_dev.svg[移除開機媒體]
