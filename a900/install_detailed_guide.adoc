...
X66240A-5（112-00600）、5公尺
 a| 
image::../media/oie_cable_sfp_gbe_copper.svg[GbE 銅線 SFP]
 a| 
網路纜線
...
X66100-5（112-00544）、5公尺
 a| 
image::../media/oie_cable100_gbe_qsfp28.svg[GbE 銅線 SFP]
 a| 
乙太網路資料、叢集網路
...
X6033A（112-00438）、3公尺
 a| 
image::../media/oie_cable_fiber_lc_connector.svg[LC 光纖連接器]
 a| 
FC光纖網路
...
X6562-R6（112-00196）、5公尺
 a| 
image::../media/oie_cable_rj45.svg[RJ-45 纜線連接器]
 a| 
管理網路與乙太網路資料
...
不適用
 a| 
image::../media/oie_cable_micro_usb.svg[Micro USB 接頭]
 a| 
...
不適用
 a| 
image::../media/oie_cable_power.svg[電源線連接器]
 a| 
開啟系統電源
...
image::../media/oie_cable_pull_tab_up.svg[纜線拉片方向]
...
| 步驟 | 在每個控制器上執行 
 ...
 a| 
image::../media/oie_legend_icon_1_lg.svg[圖說文字圖示一]
 a| 
纜線叢集互連連接埠：
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 GB 連接器]



 a| 
image::../media/oie_legend_icon_2_lp.svg[圖說文字圖示二]
 a| 
纜線控制器管理（扳手）連接埠。
...
image::../media/oie_cable_rj45.svg[RJ-45 纜線連接器]
 ...
 a| 
image::../media/oie_legend_icon_3_o.svg[圖說文字圖示三]
 a| 
纜線25 GbE網路交換器：
...
image::../media/oie_cable100_gbe_qsfp28.svg[100 GbE 纜線連接器]



 a| 
image:../media/oie_legend_icon_4_dr.svg["圖說文字圖示四"]
 a| 
纜線 32 GB FC 連線： xxx
...
image:../media/oie_cable100_gbe_qsfp28.svg["100 GbE 纜線"]



 a| 
image:../media/oie_legend_icon_2_lo.svg["圖說文字圖示二"]
 a| 
纜線控制器管理（扳手）連接埠。
...
image::../media/drw_a900fas9500_power_icon_IEOPS-1142.svg[DRW a900fas9500 電源圖示 IEOPS 1142]
...
image::../media/oie_cable_pull_tab_down.svg[纜線拉片方向]
...
| 步驟 | 在每個控制器上執行 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[編號 1]
 a| 
** 將控制器A連接埠E2A連接至機櫃上NSM A的連接埠e0a。
** 將控制器A連接埠e10b連接至機櫃NSM B上的連接埠e0b。


image::../media/oie_cable100_gbe_qsfp28.svg[100 GbE QSFP 連接器]
...
100 GbE纜線
 ...
 a| 
image::../media/oie_legend_icon_2_lo.svg[編號二]
 a| 
...
| 步驟 | 在每個控制器上執行 
 ...
 a| 
image::../media/oie_legend_icon_1_mb.svg[圖說文字圖示一]
 a| 
...
機櫃端蓋
 ...
 a| 
image::../media/legend_icon_02.png[圖說文字圖示二]
 a| 
機櫃面板
 ...
 a| 
image::../media/legend_icon_03.png[圖說文字圖示三]
 a| 
機櫃ID LED
 ...
 a| 
image::../media/legend_icon_04.png[圖說文字圖示四]
 a| 
機櫃ID設定按鈕
