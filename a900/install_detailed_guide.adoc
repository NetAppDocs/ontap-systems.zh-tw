...
image::../media/drw_a900_controller_in _chassis_ID_IEOPS-856.svg[典型叢集組態]
...
+
image::../media/drw_a900_oie_change_ns224_shelf_ID_IEOPS-836.svg[DRw A900 oie變更新南澳州224機櫃ID IEOPS 836]
