...
summary: 當系統偵測到越來越多的可修正錯誤修正代碼或不可修正的 ECC 錯誤時,請更換 AFF A900 控制器模組中的 DIMM 記憶體條。未更換故障的 DIMM 記憶體條可能會導致系統崩潰。 
---
= 更換 AFF A900 系統中的 DIMM 以修復記憶體容量錯誤
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當 AFF A900 儲存系統出現過多可修正 （CECC） 或不可修正的記憶體容量錯誤時，請更換其中的 DIMM。此類錯誤可能導致儲存系統無法開機 ONTAP。
...
+
image::../media/drw_a900_remove_PCM.svg[釋放控制器]
...
+
image::../media/drw_a900_PCM_open.svg[將主機蓋從控制器模組抬起取出]
...
+
image::../media/drw_a900_replace_PCM_dimms.svg[卸下 DIMM]
