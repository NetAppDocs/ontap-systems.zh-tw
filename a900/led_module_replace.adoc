...
[role="lead"]
更換 AFF A900 系統中的 LED USB 模組，即可還原控制台連接埠的連接和系統狀態。更換過程無需工具，也不會中斷服務。
...
+
image::../media/drw_a900_remove_replace_LED_mod.svg[取下 LED USB 模組]
