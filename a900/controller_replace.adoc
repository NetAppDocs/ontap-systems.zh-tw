...
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=30337552-b10f-4146-9bdb-adf2000df5bd["動畫-將元件移至更換的控制器"^]
...
+
image::../media/drw_a900_replace_PCM_dimms.png[DRW A900取代PCM DIMM]
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=099237f3-d7f2-4749-86e2-adf2000df53c["動畫-安裝控制器"]
