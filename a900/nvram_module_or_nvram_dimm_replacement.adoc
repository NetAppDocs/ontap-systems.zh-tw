...
summary: NVRAM 模組包含 NVRAM11 和 DIMM，以及每個 NVRAM 模組最多兩個 NVMe SSD Flash Cache 模組。 
---
= 更換 AFF A900 系統中的 NVRAM 模組或 NVRAM DIMM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當 AFF A900 系統中的 NVRAM 模組發生故障或 DIMM 出現故障時，請更換 NVRAM 模組或 NVRAM DIMM。更換過程包括從機箱中取出 NVRAM 模組、更換故障組件，然後重新安裝模組。
...
+
image::../media/drw_a900_move-remove_NVRAM_module.svg[卸下 NVRAM 模組]
...
+
image::../media/drw_a900_remove_NVRAM_module_contents.svg[移除 NVRAM 模組內容]
