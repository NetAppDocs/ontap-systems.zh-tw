...
summary: 開始更換 AFF A900 儲存系統中的開機媒體。工作流程包括：檢視更換需求、檢查加密狀態、關閉控制器、更換開機媒體、啟動恢復映像、還原加密以及驗證系統功能。 
---
= 使用手冊開機恢復流程的 AFF A900 開機媒體更換工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
開始更換 AFF A900 儲存系統中的開機媒體。工作流程包括：檢視更換需求、檢查加密狀態、關閉控制器、更換開機媒體、啟動恢復映像、還原加密以及驗證系統功能。
