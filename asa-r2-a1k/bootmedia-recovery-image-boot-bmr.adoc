...
summary: 在 ASA A1K 系統的替換開機媒體上還原 ONTAP 映像。此程序包括從 Loader 提示字元啟動開機恢復程序，並監控恢復程序，直到完成並重新啟動節點為止。 
---
= 使用自動開機恢復流程在 ASA A1K 系統上開機恢復映像
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 ASA A1K 系統中安裝新的開機媒體裝置之後，您可以啟動自動開機媒體還原程序，從合作夥伴節點還原組態。
