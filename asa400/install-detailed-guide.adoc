...
summary: 這些詳細步驟將引導您完成 ASA A400 系統的安裝，包括安裝前的準備、安裝硬體、連接控制器纜線，以及完成設定。 
---
= 請依照詳細步驟安裝您的 ASA A400 儲存系統
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
這些詳細步驟將引導您完成 ASA A400 系統的安裝，包括安裝前的準備、安裝硬體、連接控制器纜線，以及完成設定。
...
+
image::../media/drw_A400_TNSC-network-cabling.png[雙節點無交換式叢集纜線]
...
+
image::../media/drw_a400_two_ns224_shelves.png[將 NS224 機櫃連接至控制器]
...
+
image::../media/drw_a400_three_ds224c_shelves.png[將三個 NS224 機櫃連接至控制器]
