...
summary: 透過查看更換需求、關閉控制器、更換啟動媒體、恢復啟動媒體上的映像以及驗證系統功能，開始更換ASA A400儲存系統中的啟動媒體。 
---
= 使用自動化開機恢復流程的 ASA A400 開機媒體更換工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
啟動映像的自動恢復涉及系統自動識別並選擇適當的啟動選單選項。它使用合作夥伴節點上的啟動映像在ASA A400系統中的替換啟動媒體上重新安裝ONTAP 。
